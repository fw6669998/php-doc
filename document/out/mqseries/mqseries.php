...
/**
*<div id="function.mqseries-back" class="refentry">  <div class="refnamediv">   <h1 class="refname">mqseries_back</h1>   <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_back</span> &mdash; <span class="dc-title">MQSeries MQBACK</span></p>   </div>   <div class="refsect1 description" id="refsect1-function.mqseries-back-description">   <h3 class="title">说明</h3>   <div class="methodsynopsis dc-description">    <span class="type"><span class="type void">void</span></span> <span class="methodname"><strong>mqseries_back</strong></span>     ( <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hconn</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$compCode</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$reason</code></span>    )</div>    <p class="para rdfs-comment">    The    <span class="function"><strong>mqseries_back()</strong></span>    (MQBACK) call indicates to the queue manager that all the message gets and    puts that have occurred since the last syncpoint are to be backed out.    Messages put as part of a unit of work are deleted; messages retrieved as    part of a unit of work are reinstated on the queue.   </p>   <p class="para">    Using    <span class="function"><strong>mqseries_back()</strong></span>    only works in conjunction with    <span class="function">{@link mqseries_begin()}</span>    and only function when connecting directly to a Queueu manager. Not via the    mqclient interface.   </p>  </div>     <div class="refsect1 parameters" id="refsect1-function.mqseries-back-parameters">   <h3 class="title">参数</h3>   <p class="para">    <dl>            <dt>        <code class="parameter">hConn</code>      </dt>       <dd>        <p class="para">Connection handle.</p>       <p class="para">This handle represents the connection to the queue manager.</p>      </dd>                 <dt>        <code class="parameter">compCode</code>      </dt>       <dd>        <p class="para">Completion code.</p>      </dd>                 <dt>        <code class="parameter">reason</code>      </dt>       <dd>        <p class="para">Reason code qualifying the compCode.</p>      </dd>          </dl>    </p>  </div>    <div class="refsect1 returnvalues" id="refsect1-function.mqseries-back-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">没有返回值。</p>  </div>    <div class="refsect1 examples" id="refsect1-function.mqseries-back-examples">   <h3 class="title">范例</h3>   <p class="para">    <div class="example" id="example-5461">     <p><strong>Example #1       <span class="function"><strong>mqseries_back()</strong></span>      example     </strong></p>     <div class="example-contents"> <div class="phpcode"><code><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br />&nbsp;&nbsp;&nbsp;&nbsp;mqseries_back</span><span style="color: #007700">(</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #9876AA">$comp_code&nbsp;</span><span style="color: #007700">!==&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"CompCode:%d&nbsp;Reason:%d&nbsp;Text:%s&lt;br&gt;\n"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">$reason</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br /></span><span style="color: #9876AA">?&gt;</span> </span> </code></div>     </div>     </div>   </p>  </div>    <div class="refsect1 notes" id="refsect1-function.mqseries-back-notes">   <h3 class="title">注释</h3>   <blockquote class="note"><p><strong class="note">Note</strong>:     <p class="para">     <span class="function"><strong>mqseries_back()</strong></span>     will not function when using MQSeries Client to connect to a Queueu Manager.    </p>   </p></blockquote>  </div>    <div class="refsect1 seealso" id="refsect1-function.mqseries-back-seealso">   <h3 class="title">参见</h3>   <p class="para">    <ul class="simplelist">     <li class="member"><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>     <li class="member"><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>     <li class="member"><span class="function">{@link mqseries_begin()} - MQseries MQBEGIN</span></li>    </ul>   </p>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.mqseries.php">mqseries 函数</a></div></div>
*/
...
/**
*<div id="function.mqseries-begin" class="refentry">  <div class="refnamediv">   <h1 class="refname">mqseries_begin</h1>   <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_begin</span> &mdash; <span class="dc-title">MQseries MQBEGIN</span></p>   </div>   <div class="refsect1 description" id="refsect1-function.mqseries-begin-description">   <h3 class="title">说明</h3>   <div class="methodsynopsis dc-description">    <span class="type"><span class="type void">void</span></span> <span class="methodname"><strong>mqseries_begin</strong></span>     ( <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hconn</code></span>    , <span class="methodparam"><span class="type">array</span> <code class="parameter">$beginOptions</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$compCode</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$reason</code></span>    )</div>    <p class="para rdfs-comment">    The    <span class="function"><strong>mqseries_begin()</strong></span>    (MQBEGIN) call begins a unit of work that is coordinated by the queue    manager, and that may involve external resource managers.   </p>   <p class="para">    Using    <span class="function"><strong>mqseries_begin()</strong></span>    starts the unit of work. Either    <span class="function">{@link mqseries_back()}</span>    or    <span class="function">{@link mqseries_cmit()}</span>    ends the unit of work.   </p>  </div>    <div class="refsect1 parameters" id="refsect1-function.mqseries-begin-parameters">   <h3 class="title">参数</h3>   <p class="para">    <dl>            <dt>        <code class="parameter">hConn</code>      </dt>       <dd>        <p class="para">Connection handle.</p>       <p class="para">This handle represents the connection to the queue manager.</p>      </dd>                 <dt>        <code class="parameter">compCode</code>      </dt>       <dd>        <p class="para">Completion code.</p>      </dd>                 <dt>        <code class="parameter">reason</code>      </dt>       <dd>        <p class="para">Reason code qualifying the compCode.</p>      </dd>          </dl>    </p>  </div>    <div class="refsect1 returnvalues" id="refsect1-function.mqseries-begin-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">没有返回值。</p>  </div>    <div class="refsect1 examples" id="refsect1-function.mqseries-begin-examples">   <h3 class="title">范例</h3>   <p class="para">    <div class="example" id="example-5462">     <p><strong>Example #1       <span class="function"><strong>mqseries_begin()</strong></span>      example     </strong></p>     <div class="example-contents"> <div class="phpcode"><code><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br />&nbsp;&nbsp;&nbsp;&nbsp;$mqbo&nbsp;</span><span style="color: #007700">=&nbsp;array();<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_begin</span><span style="color: #007700">(&nbsp;</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$mqbo</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #9876AA">$comp_code&nbsp;</span><span style="color: #007700">!==&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;reason&nbsp;code&nbsp;2121&nbsp;is&nbsp;a&nbsp;warning&nbsp;for&nbsp;more&nbsp;information&nbsp;see&nbsp;MQSeries&nbsp;reference&nbsp;manual.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #007700">if&nbsp;(</span><span style="color: #9876AA">$reason&nbsp;</span><span style="color: #007700">!==&nbsp;</span><span style="color: #9876AA">2121</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"CompCode:%d&nbsp;Reason:%d&nbsp;Text:%s&lt;br&gt;\n"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">$reason</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br /></span><span style="color: #9876AA">?&gt;</span> </span> </code></div>     </div>     </div>   </p>  </div>    <div class="refsect1 notes" id="refsect1-function.mqseries-begin-notes">   <h3 class="title">注释</h3>   <blockquote class="note"><p><strong class="note">Note</strong>:     <p class="para">     <span class="function"><strong>mqseries_begin()</strong></span>     will not function when using MQSeries Client to connect to a Queueu Manager.    </p>   </p></blockquote>  </div>    <div class="refsect1 seealso" id="refsect1-function.mqseries-begin-seealso">   <h3 class="title">参见</h3>   <p class="para">    <ul class="simplelist">     <li class="member"><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>     <li class="member"><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>     <li class="member"><span class="function">{@link mqseries_back()} - MQSeries MQBACK</span></li>     <li class="member"><span class="function">{@link mqseries_cmit()} - MQSeries MQCMIT</span></li>    </ul>   </p>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.mqseries.php">mqseries 函数</a></div></div>
*/
...
/**
*<div id="function.mqseries-close" class="refentry">  <div class="refnamediv">   <h1 class="refname">mqseries_close</h1>   <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_close</span> &mdash; <span class="dc-title">MQSeries MQCLOSE</span></p>   </div>   <div class="refsect1 description" id="refsect1-function.mqseries-close-description">   <h3 class="title">说明</h3>   <div class="methodsynopsis dc-description">    <span class="type"><span class="type void">void</span></span> <span class="methodname"><strong>mqseries_close</strong></span>     ( <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hconn</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hobj</code></span>    , <span class="methodparam"><span class="type">int</span> <code class="parameter">$options</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$compCode</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$reason</code></span>    )</div>    <p class="para rdfs-comment">    The    <span class="function"><strong>mqseries_close()</strong></span>    (MQCLOSE) call relinquishes access to an object, and is the inverse of the    <span class="function">{@link mqseries_open()}</span>    (MQOPEN) call.   </p>  </div>    <div class="refsect1 parameters" id="refsect1-function.mqseries-close-parameters">   <h3 class="title">参数</h3>   <p class="para">    <dl>            <dt>        <code class="parameter">hConn</code>      </dt>       <dd>        <p class="para">Connection handle.</p>       <p class="para">This handle represents the connection to the queue manager.</p>      </dd>                 <dt>        <code class="parameter">hObj</code>      </dt>       <dd>        <p class="para">Object handle.</p>       <p class="para">This handle represents the object to be used.</p>      </dd>                 <dt>        <code class="parameter">options</code>      </dt>       <dd>        <p class="para"/>      </dd>                 <dt>        <code class="parameter">compCode</code>      </dt>       <dd>        <p class="para">Completion code.</p>      </dd>                 <dt>        <code class="parameter">reason</code>      </dt>       <dd>        <p class="para">Reason code qualifying the compCode.</p>      </dd>          </dl>    </p>  </div>    <div class="refsect1 returnvalues" id="refsect1-function.mqseries-close-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">没有返回值。</p>  </div>    <div class="refsect1 examples" id="refsect1-function.mqseries-close-examples">   <h3 class="title">范例</h3>   <p class="para">    <div class="example" id="example-5463">     <p><strong>Example #1       <span class="function"><strong>mqseries_close()</strong></span>      example     </strong></p>     <div class="example-contents"> <div class="phpcode"><code><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br />&nbsp;&nbsp;&nbsp;&nbsp;mqseries_close</span><span style="color: #007700">(</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$obj</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCO_NONE</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #9876AA">$comp_code&nbsp;</span><span style="color: #007700">!==&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"close&nbsp;CompCode:%d&nbsp;Reason:%d&nbsp;Text:%s&lt;br&gt;\n"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">$reason</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br /></span><span style="color: #9876AA">?&gt;</span> </span> </code></div>     </div>     </div>   </p>  </div>    <div class="refsect1 seealso" id="refsect1-function.mqseries-close-seealso">   <h3 class="title">参见</h3>   <p class="para">    <ul class="simplelist">     <li class="member"><span class="function">{@link mqseries_open()} - MQSeries MQOPEN</span></li>     <li class="member"><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>     <li class="member"><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>    </ul>   </p>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.mqseries.php">mqseries 函数</a></div></div>
*/
...
/**
*<div id="function.mqseries-cmit" class="refentry">  <div class="refnamediv">   <h1 class="refname">mqseries_cmit</h1>   <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_cmit</span> &mdash; <span class="dc-title">MQSeries MQCMIT</span></p>   </div>   <div class="refsect1 description" id="refsect1-function.mqseries-cmit-description">   <h3 class="title">说明</h3>   <div class="methodsynopsis dc-description">    <span class="type"><span class="type void">void</span></span> <span class="methodname"><strong>mqseries_cmit</strong></span>     ( <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hconn</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$compCode</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$reason</code></span>    )</div>    <p class="para rdfs-comment">    The    <span class="function"><strong>mqseries_cmit()</strong></span>    (MQCMIT) call indicates to the queue manager that the application has reached    a syncpoint, and that all of the message gets and puts that have occurred    since the last syncpoint are to be made permanent. Messages put as part of a    unit of work are made available to other applications; messages retrieved as    part of a unit of work are deleted.   </p>  </div>    <div class="refsect1 parameters" id="refsect1-function.mqseries-cmit-parameters">   <h3 class="title">参数</h3>   <p class="para">    <dl>            <dt>        <code class="parameter">hConn</code>      </dt>       <dd>        <p class="para">Connection handle.</p>       <p class="para">This handle represents the connection to the queue manager.</p>      </dd>                 <dt>        <code class="parameter">compCode</code>      </dt>       <dd>        <p class="para">Completion code.</p>      </dd>                 <dt>        <code class="parameter">reason</code>      </dt>       <dd>        <p class="para">Reason code qualifying the compCode.</p>      </dd>          </dl>    </p>  </div>    <div class="refsect1 returnvalues" id="refsect1-function.mqseries-cmit-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">没有返回值。</p>  </div>    <div class="refsect1 examples" id="refsect1-function.mqseries-cmit-examples">   <h3 class="title">范例</h3>   <p class="para">    <div class="example" id="example-5464">     <p><strong>Example #1       <span class="function"><strong>mqseries_cmit()</strong></span>      example     </strong></p>     <div class="example-contents"> <div class="phpcode"><code><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br />&nbsp;&nbsp;&nbsp;&nbsp;mqseries_cmit</span><span style="color: #007700">(</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #9876AA">$comp_code&nbsp;</span><span style="color: #007700">!==&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"cmit&nbsp;CompCode:%d&nbsp;Reason:%d&nbsp;Text:%s&lt;br&gt;\n"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">$reason</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br /></span><span style="color: #9876AA">?&gt;</span> </span> </code></div>     </div>     </div>   </p>  </div>     <div class="refsect1 notes" id="refsect1-function.mqseries-cmit-notes">   <h3 class="title">注释</h3>   <blockquote class="note"><p><strong class="note">Note</strong>:     <p class="para">     <span class="function">{@link mqseries_back()}</span>     will not function when using MQSeries Client to connect to a Queueu Manager.    </p>   </p></blockquote>  </div>     <div class="refsect1 seealso" id="refsect1-function.mqseries-cmit-seealso">   <h3 class="title">参见</h3>   <p class="para">    <ul class="simplelist">     <li class="member"><span class="function">{@link mqseries_begin()} - MQseries MQBEGIN</span></li>     <li class="member"><span class="function">{@link mqseries_back()} - MQSeries MQBACK</span></li>     <li class="member"><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>     <li class="member"><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>    </ul>   </p>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.mqseries.php">mqseries 函数</a></div></div>
*/
...
/**
*<div id="function.mqseries-conn" class="refentry">  <div class="refnamediv">   <h1 class="refname">mqseries_conn</h1>   <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_conn</span> &mdash; <span class="dc-title">MQSeries MQCONN</span></p>   </div>   <div class="refsect1 description" id="refsect1-function.mqseries-conn-description">   <h3 class="title">说明</h3>   <div class="methodsynopsis dc-description">    <span class="type"><span class="type void">void</span></span> <span class="methodname"><strong>mqseries_conn</strong></span>     ( <span class="methodparam"><span class="type">string</span> <code class="parameter">$qManagerName</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$hconn</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$compCode</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$reason</code></span>    )</div>    <p class="para rdfs-comment">    The    <span class="function"><strong>mqseries_conn()</strong></span>    (MQCONN) call connects an application program to a queue manager. It provides    a queue manager connection handle, which is used by the application on    subsequent message queuing calls.   </p>  </div>    <div class="refsect1 parameters" id="refsect1-function.mqseries-conn-parameters">   <h3 class="title">参数</h3>   <p class="para">    <dl>            <dt>        <code class="parameter">qManagerName</code>      </dt>       <dd>        <p class="para">Name of queue manager.</p>       <p class="para">Name of the queue manager the application wishes to connect.</p>      </dd>                 <dt>        <code class="parameter">hConn</code>      </dt>       <dd>        <p class="para">Connection handle.</p>       <p class="para">This handle represents the connection to the queue manager.</p>      </dd>                 <dt>        <code class="parameter">compCode</code>      </dt>       <dd>        <p class="para">Completion code.</p>      </dd>                 <dt>        <code class="parameter">reason</code>      </dt>       <dd>        <p class="para">Reason code qualifying the compCode.</p>      </dd>          </dl>    </p>  </div>    <div class="refsect1 returnvalues" id="refsect1-function.mqseries-conn-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">没有返回值。</p>  </div>    <div class="refsect1 examples" id="refsect1-function.mqseries-conn-examples">   <h3 class="title">范例</h3>   <p class="para">    <div class="example" id="example-5465">     <p><strong>Example #1       <span class="function"><strong>mqseries_conn()</strong></span>      example     </strong></p>     <div class="example-contents"> <div class="phpcode"><code><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br />&nbsp;&nbsp;&nbsp;&nbsp;mqseries_conn</span><span style="color: #007700">(</span><span style="color: #DD0000">'WMQ1'</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #9876AA">$comp_code&nbsp;</span><span style="color: #007700">!==&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"conn&nbsp;CompCode:%d&nbsp;Reason:%d&nbsp;Text:%s&lt;br&gt;\n"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">$reason</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;exit;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br /></span><span style="color: #9876AA">?&gt;</span> </span> </code></div>     </div>     </div>   </p>  </div>     <div class="refsect1 seealso" id="refsect1-function.mqseries-conn-seealso">   <h3 class="title">参见</h3>   <p class="para">    <ul class="simplelist">     <li class="member"><span class="function">{@link mqseries_disc()} - MQSeries MQDISC</span></li>    </ul>   </p>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.mqseries.php">mqseries 函数</a></div></div>
*/
...
/**
*<div id="function.mqseries-connx" class="refentry">  <div class="refnamediv">   <h1 class="refname">mqseries_connx</h1>   <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_connx</span> &mdash; <span class="dc-title">MQSeries MQCONNX</span></p>   </div>    <div class="refsect1 description" id="refsect1-function.mqseries-connx-description">   <h3 class="title">说明</h3>   <div class="methodsynopsis dc-description">    <span class="type"><span class="type void">void</span></span> <span class="methodname"><strong>mqseries_connx</strong></span>     ( <span class="methodparam"><span class="type">string</span> <code class="parameter">$qManagerName</code></span>    , <span class="methodparam"><span class="type">array</span> <code class="parameter reference">&$connOptions</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$hconn</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$compCode</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$reason</code></span>    )</div>    <p class="para rdfs-comment">    The    <span class="function"><strong>mqseries_connx()</strong></span>    (MQCONNX) call connects an application program to a queue manager. It    provides a queue manager connection handle, which is used by the application    on subsequent MQ calls.   </p>   <p class="para">    The <span class="function"><strong>mqseries_connx()</strong></span> call is like the     <span class="function">{@link mqseries_conn()}</span> (MQCONN) call, except that MQCONNX     allows options to be specified to control the way that the call works.   </p>  </div>     <div class="refsect1 parameters" id="refsect1-function.mqseries-connx-parameters">   <h3 class="title">参数</h3>   <p class="para">    <dl>            <dt>        <code class="parameter">qManagerName</code>      </dt>       <dd>        <p class="para">Name of queue manager.</p>       <p class="para">Name of the queue manager the application wishes to connect.</p>      </dd>                 <dt>        <code class="parameter">connOps</code>      </dt>       <dd>        <p class="para">Options that control the action of function</p>       <p class="para">See also the MQCNO structure.</p>      </dd>                      <dt>        <code class="parameter">hConn</code>      </dt>       <dd>        <p class="para">Connection handle.</p>       <p class="para">This handle represents the connection to the queue manager.</p>      </dd>                 <dt>        <code class="parameter">compCode</code>      </dt>       <dd>        <p class="para">Completion code.</p>      </dd>                 <dt>        <code class="parameter">reason</code>      </dt>       <dd>        <p class="para">Reason code qualifying the compCode.</p>      </dd>          </dl>    </p>  </div>     <div class="refsect1 returnvalues" id="refsect1-function.mqseries-connx-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">没有返回值。</p>  </div>     <div class="refsect1 examples" id="refsect1-function.mqseries-connx-examples">   <h3 class="title">范例</h3>   <p class="para">    <div class="example" id="example-5466">     <p><strong>Example #1       <span class="function"><strong>mqseries_connx()</strong></span>      example     </strong></p>     <div class="example-contents"> <div class="phpcode"><code><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br />&nbsp;&nbsp;&nbsp;&nbsp;$mqcno&nbsp;</span><span style="color: #007700">=&nbsp;array(<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'Version'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCNO_VERSION_2</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'Options'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCNO_STANDARD_BINDING</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'MQCD'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;array(</span><span style="color: #DD0000">'ChannelName'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #DD0000">'MQNX9420.CLIENT'</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'ConnectionName'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'TransportType'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQXPT_TCP</span><span style="color: #007700">)<br />&nbsp;&nbsp;&nbsp;&nbsp;);<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_connx</span><span style="color: #007700">(</span><span style="color: #DD0000">'MQNX9420'</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$mqcno</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #9876AA">$comp_code&nbsp;</span><span style="color: #007700">!==&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Connx&nbsp;CompCode:%d&nbsp;Reason:%d&nbsp;Text:%s&lt;br&gt;\n"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">$reason</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;exit;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;<br /></span><span style="color: #9876AA">?&gt;</span> </span> </code></div>     </div>     </div>    <div class="example" id="example-5467">     <p><strong>Example #2       <span class="function"><strong>mqseries_connx()</strong></span>      example using SSL connection &amp; OCSP Responder URL     </strong></p>     <div class="example-contents"> <div class="phpcode"><code><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br />&nbsp;&nbsp;&nbsp;&nbsp;$mqcno&nbsp;</span><span style="color: #007700">=&nbsp;array(<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'Version'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">4</span><span style="color: #007700">,&nbsp;</span><span style="color: #FF8000">//MQCNO_VERSION_4<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'Options'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCNO_STANDARD_BINDING</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'MQCD'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;array(<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'Version'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">7</span><span style="color: #007700">,&nbsp;</span><span style="color: #FF8000">//MQCD_VERSION_7<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'ConnectionName'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">,&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'TransportType'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQXPT_TCP</span><span style="color: #007700">,&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'ChannelName'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #DD0000">'CONNECTIONCHANNEL'</span><span style="color: #007700">,&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'SSLCipherSpec'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #DD0000">'NULL_SHA'<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #007700">),&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'MQSCO'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;array(<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'KeyRepository'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #DD0000">'/var/mqm/qmgrs/QUEUEMGR/ssl/key'</span><span style="color: #007700">,&nbsp;</span><span style="color: #FF8000">//Local&nbsp;path&nbsp;where&nbsp;the&nbsp;SSL&nbsp;key&nbsp;repository&nbsp;can&nbsp;be&nbsp;found<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'MQAIR'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;array(<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'Version'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">2</span><span style="color: #007700">,&nbsp;</span><span style="color: #FF8000">//MQAIR_VERSION_2<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'AuthInfoType'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">2</span><span style="color: #007700">,&nbsp;</span><span style="color: #FF8000">//MQAIT_OCSP&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'OCSPResponderURL'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #DD0000">'http://dummy.OCSP.responder'<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #007700">)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br />&nbsp;&nbsp;&nbsp;&nbsp;);<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_connx</span><span style="color: #007700">(</span><span style="color: #DD0000">'QUEUEMGR'</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$mqcno</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #9876AA">$comp_code&nbsp;</span><span style="color: #007700">!==&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Connx&nbsp;CompCode:%d&nbsp;Reason:%d&nbsp;Text:%s&lt;br&gt;\n"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">$reason</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;exit;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;<br /></span><span style="color: #9876AA">?&gt;</span> </span> </code></div>     </div>     </div>   </p>  </div>     <div class="refsect1 seealso" id="refsect1-function.mqseries-connx-seealso">   <h3 class="title">参见</h3>   <p class="para">    <ul class="simplelist">     <li class="member"><span class="function">{@link mqseries_disc()} - MQSeries MQDISC</span></li>    </ul>   </p>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.mqseries.php">mqseries 函数</a></div></div>
*/
...
/**
*<div id="function.mqseries-disc" class="refentry">  <div class="refnamediv">   <h1 class="refname">mqseries_disc</h1>   <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_disc</span> &mdash; <span class="dc-title">MQSeries MQDISC</span></p>   </div>   <div class="refsect1 description" id="refsect1-function.mqseries-disc-description">   <h3 class="title">说明</h3>   <div class="methodsynopsis dc-description">    <span class="type"><span class="type void">void</span></span> <span class="methodname"><strong>mqseries_disc</strong></span>     ( <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hconn</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$compCode</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$reason</code></span>    )</div>    <p class="para rdfs-comment">    The    <span class="function"><strong>mqseries_disc()</strong></span>    (MQDISC) call breaks the connection between the queue manager and the    application program, and is the inverse of the    <span class="function">{@link mqseries_conn()}</span>    (MQCONN) or    <span class="function">{@link mqseries_connx()}</span>    (MQCONNX) call.   </p>  </div>    <div class="refsect1 parameters" id="refsect1-function.mqseries-disc-parameters">   <h3 class="title">参数</h3>   <p class="para">    <dl>            <dt>        <code class="parameter">hConn</code>      </dt>       <dd>        <p class="para">Connection handle.</p>       <p class="para">This handle represents the connection to the queue manager.</p>      </dd>                 <dt>        <code class="parameter">compCode</code>      </dt>       <dd>        <p class="para">Completion code.</p>      </dd>                 <dt>        <code class="parameter">reason</code>      </dt>       <dd>        <p class="para">Reason code qualifying the compCode.</p>      </dd>          </dl>    </p>  </div>    <div class="refsect1 returnvalues" id="refsect1-function.mqseries-disc-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">没有返回值。</p>  </div>    <div class="refsect1 examples" id="refsect1-function.mqseries-disc-examples">   <h3 class="title">范例</h3>   <p class="para">    <div class="example" id="example-5468">     <p><strong>Example #1       <span class="function"><strong>mqseries_disc()</strong></span>      example     </strong></p>     <div class="example-contents"> <div class="phpcode"><code><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br />&nbsp;&nbsp;&nbsp;&nbsp;mqseries_disc</span><span style="color: #007700">(</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #9876AA">$comp_code&nbsp;</span><span style="color: #007700">!==&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"disc&nbsp;CompCode:%d&nbsp;Reason:%d&nbsp;Text:%s&lt;br&gt;\n"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">$reason</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br /></span><span style="color: #9876AA">?&gt;</span> </span> </code></div>     </div>     </div>   </p>  </div>    <div class="refsect1 seealso" id="refsect1-function.mqseries-disc-seealso">   <h3 class="title">参见</h3>   <p class="para">    <ul class="simplelist">     <li class="member"><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>     <li class="member"><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>    </ul>   </p>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.mqseries.php">mqseries 函数</a></div></div>
*/
...
/**
*<div id="function.mqseries-get" class="refentry">  <div class="refnamediv">   <h1 class="refname">mqseries_get</h1>   <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_get</span> &mdash; <span class="dc-title">MQSeries MQGET</span></p>   </div>   <div class="refsect1 description" id="refsect1-function.mqseries-get-description">   <h3 class="title">说明</h3>   <div class="methodsynopsis dc-description">    <span class="type"><span class="type void">void</span></span> <span class="methodname"><strong>mqseries_get</strong></span>     ( <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hConn</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hObj</code></span>    , <span class="methodparam"><span class="type">array</span> <code class="parameter reference">&$md</code></span>    , <span class="methodparam"><span class="type">array</span> <code class="parameter reference">&$gmo</code></span>    , <span class="methodparam"><span class="type">int</span> <code class="parameter reference">&$bufferLength</code></span>    , <span class="methodparam"><span class="type">string</span> <code class="parameter reference">&$msg</code></span>    , <span class="methodparam"><span class="type">int</span> <code class="parameter reference">&$data_length</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$compCode</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$reason</code></span>    )</div>    <p class="para rdfs-comment">    The    <span class="function"><strong>mqseries_get()</strong></span>    (MQGET) call retrieves a message from a local queue that has been opened    using the    <span class="function">{@link mqseries_open()}</span>    (MQOPEN) call   </p>  </div>    <div class="refsect1 parameters" id="refsect1-function.mqseries-get-parameters">   <h3 class="title">参数</h3>   <p class="para">    <dl>            <dt>        <code class="parameter">hConn</code>      </dt>       <dd>        <p class="para">Connection handle.</p>       <p class="para">This handle represents the connection to the queue manager.</p>      </dd>                 <dt>        <code class="parameter">hObj</code>      </dt>       <dd>        <p class="para">Object handle.</p>       <p class="para">This handle represents the object to be used.</p>      </dd>                 <dt>        <code class="parameter">md</code>      </dt>       <dd>        <p class="para">Message descriptor (MQMD).</p>      </dd>                 <dt>        <code class="parameter">gmo</code>      </dt>       <dd>        <p class="para">Get message options (MQGMO).</p>      </dd>                 <dt>        <code class="parameter">bufferLength</code>      </dt>       <dd>        <p class="para">Expected length of the result buffer</p>      </dd>                 <dt>        <code class="parameter">msg</code>      </dt>       <dd>        <p class="para">        Buffer holding the message that was retrieved from the object.       </p>      </dd>                 <dt>        <code class="parameter">data_length</code>      </dt>       <dd>        <p class="para">Actual buffer length</p>      </dd>                 <dt>        <code class="parameter">compCode</code>      </dt>       <dd>        <p class="para">Completion code.</p>      </dd>                 <dt>        <code class="parameter">reason</code>      </dt>       <dd>        <p class="para">Reason code qualifying the compCode.</p>      </dd>          </dl>    </p>  </div>    <div class="refsect1 returnvalues" id="refsect1-function.mqseries-get-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">没有返回值。</p>  </div>    <div class="refsect1 examples" id="refsect1-function.mqseries-get-examples">   <h3 class="title">范例</h3>   <p class="para">    <div class="example" id="example-5469">     <p><strong>Example #1       <span class="function"><strong>mqseries_get()</strong></span>      example     </strong></p>     <div class="example-contents"> <div class="phpcode"><code><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br /></span><span style="color: #FF8000">//&nbsp;open&nbsp;connection&nbsp;to&nbsp;the&nbsp;queue&nbsp;manager<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_conn</span><span style="color: #007700">(</span><span style="color: #DD0000">'WMQ1'</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">//&nbsp;$conn&nbsp;now&nbsp;hold&nbsp;the&nbsp;reference&nbsp;to&nbsp;the&nbsp;connection&nbsp;to&nbsp;the&nbsp;queue&nbsp;manager.<br /><br />//&nbsp;open&nbsp;the&nbsp;connection&nbsp;to&nbsp;the&nbsp;testq&nbsp;queue<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_open</span><span style="color: #007700">(<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;array(</span><span style="color: #DD0000">'ObjectName'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #DD0000">'TESTQ'</span><span style="color: #007700">),<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQOO_INPUT_AS_Q_DEF&nbsp;</span><span style="color: #007700">|&nbsp;</span><span style="color: #9876AA">MQSERIES_MQOO_FAIL_IF_QUIESCING&nbsp;</span><span style="color: #007700">|&nbsp;</span><span style="color: #9876AA">MQSERIES_MQOO_OUTPUT</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$obj</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">//&nbsp;$obj&nbsp;now&nbsp;holds&nbsp;the&nbsp;reference&nbsp;to&nbsp;the&nbsp;object&nbsp;(TESTQ)<br /><br />//&nbsp;setup&nbsp;empty&nbsp;message&nbsp;descriptor.<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$mdg&nbsp;</span><span style="color: #007700">=&nbsp;array();<br /></span><span style="color: #FF8000">//&nbsp;setup&nbsp;get&nbsp;message&nbsp;options&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$gmo&nbsp;</span><span style="color: #007700">=&nbsp;array(</span><span style="color: #DD0000">'Options'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQGMO_FAIL_IF_QUIESCING&nbsp;</span><span style="color: #007700">|&nbsp;</span><span style="color: #9876AA">MQSERIES_MQGMO_WAIT</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">'WaitInterval'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">3000</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">//&nbsp;get&nbsp;the&nbsp;message&nbsp;from&nbsp;the&nbsp;queue&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_get</span><span style="color: #007700">(</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$obj</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$mdg</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$gmo</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">255</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$msg</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$data_length</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #9876AA">$comp_code&nbsp;</span><span style="color: #007700">!==&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"GET&nbsp;CompCode:%d&nbsp;Reason:%d&nbsp;Text:%s&lt;br&gt;"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">$reason</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;<br /></span><span style="color: #FF8000">//&nbsp;close&nbsp;the&nbsp;object&nbsp;reference&nbsp;$obj&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_close</span><span style="color: #007700">(</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$obj</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCO_NONE</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">//&nbsp;disconnect&nbsp;from&nbsp;the&nbsp;queue&nbsp;manager.&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_disc</span><span style="color: #007700">(</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;<br /></span><span style="color: #9876AA">?&gt;</span> </span> </code></div>     </div>     </div>   </p>  </div>    <div class="refsect1 seealso" id="refsect1-function.mqseries-get-seealso">   <h3 class="title">参见</h3>   <p class="para">    <ul class="simplelist">     <li class="member"><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>     <li class="member"><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>     <li class="member"><span class="function">{@link mqseries_open()} - MQSeries MQOPEN</span></li>     <li class="member"><span class="function">{@link mqseries_put()} - MQSeries MQPUT</span></li>    </ul>   </p>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.mqseries.php">mqseries 函数</a></div></div>
*/
...
/**
*<div id="function.mqseries-inq" class="refentry">  <div class="refnamediv">   <h1 class="refname">mqseries_inq</h1>   <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_inq</span> &mdash; <span class="dc-title">MQSeries MQINQ</span></p>   </div>   <div class="refsect1 description" id="refsect1-function.mqseries-inq-description">   <h3 class="title">说明</h3>   <div class="methodsynopsis dc-description">    <span class="type"><span class="type void">void</span></span> <span class="methodname"><strong>mqseries_inq</strong></span>     ( <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hconn</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hobj</code></span>    , <span class="methodparam"><span class="type">int</span> <code class="parameter">$selectorCount</code></span>    , <span class="methodparam"><span class="type">array</span> <code class="parameter">$selectors</code></span>    , <span class="methodparam"><span class="type">int</span> <code class="parameter">$intAttrCount</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$intAttr</code></span>    , <span class="methodparam"><span class="type">int</span> <code class="parameter">$charAttrLength</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$charAttr</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$compCode</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$reason</code></span>    )</div>    <p class="para rdfs-comment">    The    <span class="function"><strong>mqseries_inq()</strong></span>    (MQINQ) call returns an array of integers and a set of character strings    containing the attributes of an object.   </p>  </div>    <div class="refsect1 parameters" id="refsect1-function.mqseries-inq-parameters">   <h3 class="title">参数</h3>   <p class="para">    <dl>            <dt>        <code class="parameter">hConn</code>      </dt>       <dd>        <p class="para">Connection handle.</p>       <p class="para">This handle represents the connection to the queue manager.</p>      </dd>                 <dt>        <code class="parameter">hObj</code>      </dt>       <dd>        <p class="para">Object handle.</p>       <p class="para">This handle represents the object to be used.</p>      </dd>                 <dt>        <code class="parameter">selectorCount</code>      </dt>       <dd>        <p class="para">Count of selectors.</p>      </dd>                 <dt>        <code class="parameter">selectors</code>      </dt>       <dd>        <p class="para">Array of attribute selectors.</p>      </dd>                 <dt>        <code class="parameter">intAttrLength</code>      </dt>       <dd>        <p class="para">Count of integer attributes.</p>      </dd>                 <dt>        <code class="parameter">intAttr</code>      </dt>       <dd>        <p class="para">Array of integer attributes.</p>      </dd>                 <dt>        <code class="parameter">charAttrLength</code>      </dt>       <dd>        <p class="para">Length of character attributes buffer.</p>      </dd>                 <dt>        <code class="parameter">charAttr</code>      </dt>       <dd>        <p class="para">Character attributes.</p>      </dd>                 <dt>        <code class="parameter">compCode</code>      </dt>       <dd>        <p class="para">Completion code.</p>      </dd>                 <dt>        <code class="parameter">reason</code>      </dt>       <dd>        <p class="para">Reason code qualifying the compCode.</p>      </dd>          </dl>    </p>  </div>    <div class="refsect1 returnvalues" id="refsect1-function.mqseries-inq-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">没有返回值。</p>  </div>    <div class="refsect1 examples" id="refsect1-function.mqseries-inq-examples">   <h3 class="title">范例</h3>   <p class="para">    <div class="example" id="example-5470">     <p><strong>Example #1       <span class="function"><strong>mqseries_inq()</strong></span>      example     </strong></p>     <div class="example-contents"> <div class="phpcode"><code><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br />&nbsp;&nbsp;&nbsp;&nbsp;$int_attr&nbsp;</span><span style="color: #007700">=&nbsp;array();<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$char_attr&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #DD0000">""</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_inq</span><span style="color: #007700">(</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$obj</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">1</span><span style="color: #007700">,&nbsp;array(</span><span style="color: #9876AA">MQSERIES_MQCA_Q_MGR_NAME</span><span style="color: #007700">),&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$int_attr</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">48</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$char_attr</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #9876AA">$comp_code&nbsp;</span><span style="color: #007700">!==&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"INQ&nbsp;CompCode:%d&nbsp;Reason:%d&nbsp;Text:%s&lt;br&gt;\n"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">$reason</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;}&nbsp;else&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;echo&nbsp;</span><span style="color: #DD0000">"INQ&nbsp;QManager&nbsp;name&nbsp;result&nbsp;"</span><span style="color: #007700">.</span><span style="color: #9876AA">$char_attr</span><span style="color: #007700">.</span><span style="color: #DD0000">"&lt;br&gt;\n"</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br /></span><span style="color: #9876AA">?&gt;</span> </span> </code></div>     </div>     </div>   </p>  </div>    <div class="refsect1 seealso" id="refsect1-function.mqseries-inq-seealso">   <h3 class="title">参见</h3>   <p class="para">    <ul class="simplelist">     <li class="member"><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>     <li class="member"><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>     <li class="member"><span class="function">{@link mqseries_open()} - MQSeries MQOPEN</span></li>    </ul>   </p>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.mqseries.php">mqseries 函数</a></div></div>
*/
...
/**
*<div id="function.mqseries-open" class="refentry">  <div class="refnamediv">   <h1 class="refname">mqseries_open</h1>   <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_open</span> &mdash; <span class="dc-title">MQSeries MQOPEN</span></p>   </div>   <div class="refsect1 description" id="refsect1-function.mqseries-open-description">   <h3 class="title">说明</h3>   <div class="methodsynopsis dc-description">    <span class="type"><span class="type void">void</span></span> <span class="methodname"><strong>mqseries_open</strong></span>     ( <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hconn</code></span>    , <span class="methodparam"><span class="type">array</span> <code class="parameter reference">&$objDesc</code></span>    , <span class="methodparam"><span class="type">int</span> <code class="parameter">$option</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$hobj</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$compCode</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$reason</code></span>    )</div>    <p class="para rdfs-comment">    The    <span class="function"><strong>mqseries_open()</strong></span>    (MQOPEN) call establishes access to an object.   </p>  </div>    <div class="refsect1 parameters" id="refsect1-function.mqseries-open-parameters">   <h3 class="title">参数</h3>   <p class="para">    <dl>            <dt>        <code class="parameter">hConn</code>      </dt>       <dd>        <p class="para">Connection handle.</p>       <p class="para">This handle represents the connection to the queue manager.</p>      </dd>                 <dt>        <code class="parameter">objDesc</code>      </dt>       <dd>        <p class="para">Object descriptor. (MQOD)</p>      </dd>                 <dt>        <code class="parameter">options</code>      </dt>       <dd>        <p class="para">Options that control the action of the function.</p>      </dd>                 <dt>        <code class="parameter">hObj</code>      </dt>       <dd>        <p class="para">Object handle.</p>       <p class="para">This handle represents the object to be used.</p>      </dd>                 <dt>        <code class="parameter">compCode</code>      </dt>       <dd>        <p class="para">Completion code.</p>      </dd>                 <dt>        <code class="parameter">reason</code>      </dt>       <dd>        <p class="para">Reason code qualifying the compCode.</p>      </dd>          </dl>    </p>  </div>    <div class="refsect1 returnvalues" id="refsect1-function.mqseries-open-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">没有返回值。</p>  </div>    <div class="refsect1 examples" id="refsect1-function.mqseries-open-examples">   <h3 class="title">范例</h3>   <p class="para">    <div class="example" id="example-5471">     <p><strong>Example #1       <span class="function"><strong>mqseries_open()</strong></span>      example     </strong></p>     <div class="example-contents"> <div class="phpcode"><code><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br />&nbsp;&nbsp;&nbsp;&nbsp;$mqods&nbsp;</span><span style="color: #007700">=&nbsp;array(</span><span style="color: #DD0000">'ObjectName'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #DD0000">'TESTQ'</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_open</span><span style="color: #007700">(<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$mqods</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQOO_INPUT_AS_Q_DEF&nbsp;</span><span style="color: #007700">|&nbsp;</span><span style="color: #9876AA">MQSERIES_MQOO_FAIL_IF_QUIESCING&nbsp;</span><span style="color: #007700">|&nbsp;</span><span style="color: #9876AA">MQSERIES_MQOO_OUTPUT</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$obj</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #9876AA">$comp_code&nbsp;</span><span style="color: #007700">!==&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"open&nbsp;CompCode:%d&nbsp;Reason:%d&nbsp;Text:%s&lt;br&gt;\n"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">$reason</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;exit;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br /></span><span style="color: #9876AA">?&gt;</span> </span> </code></div>     </div>     </div>   </p>  </div>    <div class="refsect1 seealso" id="refsect1-function.mqseries-open-seealso">   <h3 class="title">参见</h3>   <p class="para">    <ul class="simplelist">     <li class="member"><span class="function">{@link mqseries_close()} - MQSeries MQCLOSE</span></li>    </ul>   </p>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.mqseries.php">mqseries 函数</a></div></div>
*/
...
/**
*<div id="function.mqseries-put1" class="refentry">  <div class="refnamediv">   <h1 class="refname">mqseries_put1</h1>   <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_put1</span> &mdash; <span class="dc-title">MQSeries MQPUT1</span></p>   </div>    <div class="refsect1 description" id="refsect1-function.mqseries-put1-description">   <h3 class="title">说明</h3>   <div class="methodsynopsis dc-description">    <span class="type"><span class="type void">void</span></span> <span class="methodname"><strong>mqseries_put1</strong></span>     ( <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hconn</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$objDesc</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$msgDesc</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$pmo</code></span>    , <span class="methodparam"><span class="type">string</span> <code class="parameter">$buffer</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$compCode</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$reason</code></span>    )</div>    <p class="para rdfs-comment">    The    <span class="function"><strong>mqseries_put1()</strong></span>    (MQPUT1) call puts one message on a queue. The queue need not be open.   </p>   <p class="para">    You can use both the <span class="function">{@link mqseries_put()}</span> and <span class="function"><strong>mqseries_put1()</strong></span>    calls to put messages on a queue; which call to use depends on the circumstances.    Use the <span class="function">{@link mqseries_put()}</span> (MQPUT) call to place multiple messages on the same queue.    Use the <span class="function"><strong>mqseries_put1()</strong></span> (MQPUT1) call to put only one message on a queue.    This call encapsulates the MQOPEN, MQPUT, and MQCLOSE calls into a single call, minimizing the    number of calls that must be issued.   </p>  </div>     <div class="refsect1 parameters" id="refsect1-function.mqseries-put1-parameters">   <h3 class="title">参数</h3>   <p class="para">    <dl>            <dt>        <code class="parameter">hConn</code>      </dt>       <dd>        <p class="para">Connection handle.</p>       <p class="para">This handle represents the connection to the queue manager.</p>      </dd>                 <dt>        <code class="parameter">objDesc</code>      </dt>       <dd>        <p class="para">Object descriptor. (MQOD)</p>       <p class="para">        This is a structure which identifies the queue to which the message is        added.       </p>      </dd>                 <dt>        <code class="parameter">msgDesc</code>      </dt>       <dd>        <p class="para">Message descriptor (MQMD).</p>      </dd>                 <dt>        <code class="parameter">pmo</code>      </dt>       <dd>        <p class="para">Put message options (MQPMO).</p>      </dd>                      <dt>        <code class="parameter">compCode</code>      </dt>       <dd>        <p class="para">Completion code.</p>      </dd>                 <dt>        <code class="parameter">reason</code>      </dt>       <dd>        <p class="para">Reason code qualifying the compCode.</p>      </dd>          </dl>    </p>  </div>     <div class="refsect1 returnvalues" id="refsect1-function.mqseries-put1-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">没有返回值。</p>  </div>     <div class="refsect1 seealso" id="refsect1-function.mqseries-put1-seealso">   <h3 class="title">参见</h3>   <p class="para">    <ul class="simplelist">     <li class="member"><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>     <li class="member"><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>     <li class="member"><span class="function">{@link mqseries_open()} - MQSeries MQOPEN</span></li>     <li class="member"><span class="function">{@link mqseries_get()} - MQSeries MQGET</span></li>    </ul>   </p>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.mqseries.php">mqseries 函数</a></div></div>
*/
...
/**
*<div id="function.mqseries-put" class="refentry">  <div class="refnamediv">   <h1 class="refname">mqseries_put</h1>   <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_put</span> &mdash; <span class="dc-title">MQSeries MQPUT</span></p>   </div>   <div class="refsect1 description" id="refsect1-function.mqseries-put-description">   <h3 class="title">说明</h3>   <div class="methodsynopsis dc-description">    <span class="type"><span class="type void">void</span></span> <span class="methodname"><strong>mqseries_put</strong></span>     ( <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hConn</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hObj</code></span>    , <span class="methodparam"><span class="type">array</span> <code class="parameter reference">&$md</code></span>    , <span class="methodparam"><span class="type">array</span> <code class="parameter reference">&$pmo</code></span>    , <span class="methodparam"><span class="type">string</span> <code class="parameter">$message</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$compCode</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$reason</code></span>    )</div>    <p class="para rdfs-comment">    The    <span class="function"><strong>mqseries_put()</strong></span>    (MQPUT) call puts a message on a queue or distribution list. The queue or    distribution list must already be open.   </p>  </div>    <div class="refsect1 parameters" id="refsect1-function.mqseries-put-parameters">   <h3 class="title">参数</h3>   <p class="para">    <dl>            <dt>        <code class="parameter">hConn</code>      </dt>       <dd>        <p class="para">Connection handle.</p>       <p class="para">This handle represents the connection to the queue manager.</p>      </dd>                 <dt>        <code class="parameter">hObj</code>      </dt>       <dd>        <p class="para">Object handle.</p>       <p class="para">This handle represents the object to be used.</p>      </dd>                 <dt>        <code class="parameter">md</code>      </dt>       <dd>        <p class="para">Message descriptor (MQMD).</p>      </dd>                 <dt>        <code class="parameter">pmo</code>      </dt>       <dd>        <p class="para">Put message options (MQPMO).</p>      </dd>                 <dt>        <code class="parameter">message</code>      </dt>       <dd>        <p class="para">The actual message to put onto the queue.</p>      </dd>                 <dt>        <code class="parameter">compCode</code>      </dt>       <dd>        <p class="para">Completion code.</p>      </dd>                 <dt>        <code class="parameter">reason</code>      </dt>       <dd>        <p class="para">Reason code qualifying the compCode.</p>      </dd>          </dl>    </p>  </div>    <div class="refsect1 returnvalues" id="refsect1-function.mqseries-put-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">没有返回值。</p>  </div>    <div class="refsect1 examples" id="refsect1-function.mqseries-put-examples">   <h3 class="title">范例</h3>   <p class="para">    <div class="example" id="example-5472">     <p><strong>Example #1       <span class="function"><strong>mqseries_put()</strong></span>      example     </strong></p>     <div class="example-contents"> <div class="phpcode"><code><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br /></span><span style="color: #FF8000">//&nbsp;open&nbsp;connection&nbsp;to&nbsp;the&nbsp;queue&nbsp;manager<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_conn</span><span style="color: #007700">(</span><span style="color: #DD0000">'WMQ1'</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">//&nbsp;$conn&nbsp;now&nbsp;hold&nbsp;the&nbsp;reference&nbsp;to&nbsp;the&nbsp;connection&nbsp;to&nbsp;the&nbsp;queue&nbsp;manager.<br /><br />//&nbsp;open&nbsp;the&nbsp;connectio&nbsp;to&nbsp;the&nbsp;testq&nbsp;queueu<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_open</span><span style="color: #007700">(<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;array(</span><span style="color: #DD0000">'ObjectName'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #DD0000">'TESTQ'</span><span style="color: #007700">),<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQOO_INPUT_AS_Q_DEF&nbsp;</span><span style="color: #007700">|&nbsp;</span><span style="color: #9876AA">MQSERIES_MQOO_FAIL_IF_QUIESCING&nbsp;</span><span style="color: #007700">|&nbsp;</span><span style="color: #9876AA">MQSERIES_MQOO_OUTPUT</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$obj</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">//&nbsp;$obj&nbsp;now&nbsp;holds&nbsp;the&nbsp;reference&nbsp;to&nbsp;the&nbsp;object&nbsp;(TESTQ)<br /><br />//&nbsp;setup&nbsp;the&nbsp;message&nbsp;descriptor&nbsp;array.&nbsp;Check&nbsp;MQSeries&nbsp;reference&nbsp;manuals.<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$md&nbsp;</span><span style="color: #007700">=&nbsp;array(<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'Version'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQMD_VERSION_1</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'Expiry'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQEI_UNLIMITED</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'Report'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQRO_NONE</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'MsgType'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQMT_DATAGRAM</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'Format'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQFMT_STRING</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'Priority'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">1</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'Persistence'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQPER_PERSISTENT</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">//&nbsp;setup&nbsp;the&nbsp;put&nbsp;message&nbsp;options.<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">$pmo&nbsp;</span><span style="color: #007700">=&nbsp;array(</span><span style="color: #DD0000">'Options'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #9876AA">MQSERIES_MQPMO_NEW_MSG_ID</span><span style="color: #007700">|</span><span style="color: #9876AA">MQSERIES_MQPMO_SYNCPOINT</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;<br /></span><span style="color: #FF8000">//&nbsp;put&nbsp;the&nbsp;message&nbsp;'Ping'&nbsp;on&nbsp;the&nbsp;queueu.<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_put</span><span style="color: #007700">(</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$obj</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$md</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$pmo</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">'Ping'</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #9876AA">$comp_code&nbsp;</span><span style="color: #007700">!==&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"put&nbsp;CompCode:%d&nbsp;Reason:%d&nbsp;Text:%s&lt;br&gt;\n"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">$reason</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br /><br /></span><span style="color: #FF8000">//&nbsp;close&nbsp;the&nbsp;object&nbsp;reference&nbsp;$obj&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_close</span><span style="color: #007700">(</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$obj</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCO_NONE</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">//&nbsp;disconnect&nbsp;from&nbsp;the&nbsp;queue&nbsp;manager.&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">mqseries_disc</span><span style="color: #007700">(</span><span style="color: #9876AA">$conn</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;<br /></span><span style="color: #9876AA">?&gt;</span> </span> </code></div>     </div>     </div>   </p>  </div>    <div class="refsect1 seealso" id="refsect1-function.mqseries-put-seealso">   <h3 class="title">参见</h3>   <p class="para">    <ul class="simplelist">     <li class="member"><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>     <li class="member"><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>     <li class="member"><span class="function">{@link mqseries_open()} - MQSeries MQOPEN</span></li>     <li class="member"><span class="function">{@link mqseries_get()} - MQSeries MQGET</span></li>    </ul>   </p>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.mqseries.php">mqseries 函数</a></div></div>
*/
...
/**
*<div id="function.mqseries-set" class="refentry">  <div class="refnamediv">   <h1 class="refname">mqseries_set</h1>   <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_set</span> &mdash; <span class="dc-title">MQSeries MQSET</span></p>   </div>   <div class="refsect1 description" id="refsect1-function.mqseries-set-description">   <h3 class="title">说明</h3>   <div class="methodsynopsis dc-description">    <span class="type"><span class="type void">void</span></span> <span class="methodname"><strong>mqseries_set</strong></span>     ( <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hConn</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter">$hObj</code></span>    , <span class="methodparam"><span class="type">int</span> <code class="parameter">$selectorCount</code></span>    , <span class="methodparam"><span class="type">array</span> <code class="parameter">$selectors</code></span>    , <span class="methodparam"><span class="type">int</span> <code class="parameter">$intAttrCount</code></span>    , <span class="methodparam"><span class="type">array</span> <code class="parameter">$intAttrs</code></span>    , <span class="methodparam"><span class="type">int</span> <code class="parameter">$charAttrLength</code></span>    , <span class="methodparam"><span class="type">array</span> <code class="parameter">$charAttrs</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$compCode</code></span>    , <span class="methodparam"><span class="type">resource</span> <code class="parameter reference">&$reason</code></span>    )</div>    <p class="para rdfs-comment">    The <span class="function"><strong>mqseries_set()</strong></span>    (MQSET) call is used to change the attributes of an object represented by a    handle. The object must be a queue.   </p>  </div>    <div class="refsect1 parameters" id="refsect1-function.mqseries-set-parameters">   <h3 class="title">参数</h3>   <p class="para">    <dl>            <dt>        <code class="parameter">hConn</code>      </dt>       <dd>        <p class="para">Connection handle.</p>       <p class="para">This handle represents the connection to the queue manager.</p>      </dd>                 <dt>        <code class="parameter">hObj</code>      </dt>       <dd>        <p class="para">Object handle.</p>       <p class="para">This handle represents the object to be used.</p>      </dd>                 <dt>        <code class="parameter">selectorCount</code>      </dt>       <dd>        <p class="para">Count of selectors.</p>      </dd>                 <dt>        <code class="parameter">selectors</code>      </dt>       <dd>        <p class="para">Array of attribute selectors.</p>      </dd>                 <dt>        <code class="parameter">intAttrCount</code>      </dt>       <dd>        <p class="para">Count of integer attributes.</p>      </dd>                 <dt>        <code class="parameter">intAttrs</code>      </dt>       <dd>        <p class="para">Array of integer attributes.</p>      </dd>                 <dt>        <code class="parameter">charAttrLength</code>      </dt>       <dd>        <p class="para">Length of character attributes buffer.</p>      </dd>                 <dt>        <code class="parameter">charAttrs</code>      </dt>       <dd>        <p class="para">Character attributes.</p>      </dd>                 <dt>        <code class="parameter">compCode</code>      </dt>       <dd>        <p class="para">Completion code.</p>      </dd>                 <dt>        <code class="parameter">reason</code>      </dt>       <dd>        <p class="para">Reason code qualifying the compCode.</p>      </dd>          </dl>    </p>  </div>    <div class="refsect1 returnvalues" id="refsect1-function.mqseries-set-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">没有返回值。</p>  </div>    <div class="refsect1 seealso" id="refsect1-function.mqseries-set-seealso">   <h3 class="title">参见</h3>   <p class="para">    <ul class="simplelist">     <li class="member"><span class="function">{@link mqseries_inq()} - MQSeries MQINQ</span></li>    </ul>   </p>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.mqseries.php">mqseries 函数</a></div></div>
*/
...
/**
*<div id="function.mqseries-strerror" class="refentry">  <div class="refnamediv">   <h1 class="refname">mqseries_strerror</h1>   <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_strerror</span> &mdash; <span class="dc-title">Returns the error message corresponding to a result code (MQRC)</span></p>   </div>   <div class="refsect1 description" id="refsect1-function.mqseries-strerror-description">   <h3 class="title">说明</h3>   <div class="methodsynopsis dc-description">    <span class="type">string</span> <span class="methodname"><strong>mqseries_strerror</strong></span>     ( <span class="methodparam"><span class="type">int</span> <code class="parameter">$reason</code></span>    )</div>    <p class="para rdfs-comment">    <span class="function"><strong>mqseries_strerror()</strong></span>    returns the message that correspond to the reason result code.   </p>  </div>    <div class="refsect1 parameters" id="refsect1-function.mqseries-strerror-parameters">   <h3 class="title">参数</h3>   <p class="para">    <dl>            <dt>        <code class="parameter">reason</code>      </dt>       <dd>        <p class="para">Reason code qualifying the compCode.</p>      </dd>          </dl>    </p>  </div>    <div class="refsect1 returnvalues" id="refsect1-function.mqseries-strerror-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">string representation of the reason code message.</p>  </div>    <div class="refsect1 examples" id="refsect1-function.mqseries-strerror-examples">   <h3 class="title">范例</h3>   <p class="para">    <div class="example" id="example-5473">     <p><strong>Example #1       <span class="function"><strong>mqseries_strerror()</strong></span>      example     </strong></p>     <div class="example-contents"> <div class="phpcode"><code><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #007700">if&nbsp;(</span><span style="color: #9876AA">$comp_code&nbsp;</span><span style="color: #007700">!==&nbsp;</span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"open&nbsp;CompCode:%d&nbsp;Reason:%d&nbsp;Text:%s&lt;br&gt;\n"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$comp_code</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">$reason</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">$reason</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;exit;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br /></span><span style="color: #9876AA">?&gt;</span> </span> </code></div>     </div>      <div class="example-contents"><p>以上例程会输出：</p></div>     <div class="example-contents screen"> <div class="cdata"><pre> Connx CompCode:2 Reason:2059 Text:Queue manager not available for connection.                     </pre></div>     </div>    </div>   </p>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.mqseries.php">mqseries 函数</a></div></div>
 * @return string*/
