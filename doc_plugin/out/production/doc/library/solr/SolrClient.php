...
/**
*<div id="class.solrclient" class="reference">   <h1 class="title">The SolrClient class</h1>     <div class="partintro"><p class="verinfo">(PECL solr &gt;= 0.9.2)</p>     <div class="section" id="solrclient.intro">    <h2 class="title">简介</h2>    <p class="para">     Used to send requests to a Solr server. Currently, cloning and serialization of SolrClient instances is not supported.    </p>   </div>     <div class="section" id="solrclient.synopsis">    <h2 class="title">类摘要</h2>      <div class="classsynopsis">     <div class="ooclass"></div>       <div class="classsynopsisinfo">      <span class="ooclass">       <span class="modifier">final</span>       <strong class="classname">SolrClient</strong>      </span>      {</div>      <div class="classsynopsisinfo classsynopsisinfo_comment">// 常量 </div>     <div class="fieldsynopsis">      <span class="modifier">const</span>      <span class="type">integer</span>       <var class="fieldsynopsis_varname"><a href="http://php.net/manual/zh/class.solrclient.php#solrclient.constants.search-servlet-type"><var class="varname">SEARCH_SERVLET_TYPE</var></a></var>      <span class="initializer"> = 1</span>     ;</div>      <div class="fieldsynopsis">      <span class="modifier">const</span>      <span class="type">integer</span>       <var class="fieldsynopsis_varname"><a href="http://php.net/manual/zh/class.solrclient.php#solrclient.constants.update-servlet-type"><var class="varname">UPDATE_SERVLET_TYPE</var></a></var>      <span class="initializer"> = 2</span>     ;</div>      <div class="fieldsynopsis">      <span class="modifier">const</span>      <span class="type">integer</span>       <var class="fieldsynopsis_varname"><a href="http://php.net/manual/zh/class.solrclient.php#solrclient.constants.threads-servlet-type"><var class="varname">THREADS_SERVLET_TYPE</var></a></var>      <span class="initializer"> = 4</span>     ;</div>      <div class="fieldsynopsis">      <span class="modifier">const</span>      <span class="type">integer</span>       <var class="fieldsynopsis_varname"><a href="http://php.net/manual/zh/class.solrclient.php#solrclient.constants.ping-servlet-type"><var class="varname">PING_SERVLET_TYPE</var></a></var>      <span class="initializer"> = 8</span>     ;</div>      <div class="fieldsynopsis">      <span class="modifier">const</span>      <span class="type">integer</span>       <var class="fieldsynopsis_varname"><a href="http://php.net/manual/zh/class.solrclient.php#solrclient.constants.terms-servlet-type"><var class="varname">TERMS_SERVLET_TYPE</var></a></var>      <span class="initializer"> = 16</span>     ;</div>      <div class="fieldsynopsis">      <span class="modifier">const</span>      <span class="type">integer</span>       <var class="fieldsynopsis_varname"><a href="http://php.net/manual/zh/class.solrclient.php#solrclient.constants.system-servlet-type"><var class="varname">SYSTEM_SERVLET_TYPE</var></a></var>      <span class="initializer"> = 32</span>     ;</div>      <div class="fieldsynopsis">      <span class="modifier">const</span>      <span class="type">string</span>       <var class="fieldsynopsis_varname"><a href="http://php.net/manual/zh/class.solrclient.php#solrclient.constants.default-search-servlet"><var class="varname">DEFAULT_SEARCH_SERVLET</var></a></var>      <span class="initializer"> = select</span>     ;</div>      <div class="fieldsynopsis">      <span class="modifier">const</span>      <span class="type">string</span>       <var class="fieldsynopsis_varname"><a href="http://php.net/manual/zh/class.solrclient.php#solrclient.constants.default-update-servlet"><var class="varname">DEFAULT_UPDATE_SERVLET</var></a></var>      <span class="initializer"> = update</span>     ;</div>      <div class="fieldsynopsis">      <span class="modifier">const</span>      <span class="type">string</span>       <var class="fieldsynopsis_varname"><a href="http://php.net/manual/zh/class.solrclient.php#solrclient.constants.default-threads-servlet"><var class="varname">DEFAULT_THREADS_SERVLET</var></a></var>      <span class="initializer"> = admin/threads</span>     ;</div>      <div class="fieldsynopsis">      <span class="modifier">const</span>      <span class="type">string</span>       <var class="fieldsynopsis_varname"><a href="http://php.net/manual/zh/class.solrclient.php#solrclient.constants.default-ping-servlet"><var class="varname">DEFAULT_PING_SERVLET</var></a></var>      <span class="initializer"> = admin/ping</span>     ;</div>      <div class="fieldsynopsis">      <span class="modifier">const</span>      <span class="type">string</span>       <var class="fieldsynopsis_varname"><a href="http://php.net/manual/zh/class.solrclient.php#solrclient.constants.default-terms-servlet"><var class="varname">DEFAULT_TERMS_SERVLET</var></a></var>      <span class="initializer"> = terms</span>     ;</div>      <div class="fieldsynopsis">      <span class="modifier">const</span>      <span class="type">string</span>       <var class="fieldsynopsis_varname"><a href="http://php.net/manual/zh/class.solrclient.php#solrclient.constants.default-system-servlet"><var class="varname">DEFAULT_SYSTEM_SERVLET</var></a></var>      <span class="initializer"> = admin/system</span>     ;</div>           <div class="classsynopsisinfo classsynopsisinfo_comment">// 方法 </div>     <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">SolrUpdateResponse</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.adddocument.php" class="methodname">addDocument</a></span>     ( <span class="methodparam"><span class="type"><a href="http://php.net/manual/zh/class.solrinputdocument.php" class="type SolrInputDocument">SolrInputDocument</a></span> <code class="parameter">$doc</code></span>    [, <span class="methodparam"><span class="type">bool</span> <code class="parameter">$overwrite</code><span class="initializer"> = <strong><code>TRUE</code></strong></span></span>    [, <span class="methodparam"><span class="type">int</span> <code class="parameter">$commitWithin</code><span class="initializer"> = 0</span></span>   ]] )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">void</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.adddocuments.php" class="methodname">addDocuments</a></span>     ( <span class="methodparam"><span class="type">array</span> <code class="parameter">$docs</code></span>    [, <span class="methodparam"><span class="type">bool</span> <code class="parameter">$overwrite</code><span class="initializer"> = <strong><code>TRUE</code></strong></span></span>    [, <span class="methodparam"><span class="type">int</span> <code class="parameter">$commitWithin</code><span class="initializer"> = 0</span></span>   ]] )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">SolrUpdateResponse</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.commit.php" class="methodname">commit</a></span>     ([ <span class="methodparam"><span class="type">bool</span> <code class="parameter">$softCommit</code><span class="initializer"> = <strong><code>FALSE</code></strong></span></span>    [, <span class="methodparam"><span class="type">bool</span> <code class="parameter">$waitSearcher</code><span class="initializer"> = <strong><code>TRUE</code></strong></span></span>    [, <span class="methodparam"><span class="type">bool</span> <code class="parameter">$expungeDeletes</code><span class="initializer"> = <strong><code>FALSE</code></strong></span></span>   ]]] )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.construct.php" class="methodname">__construct</a></span>     ( <span class="methodparam"><span class="type">array</span> <code class="parameter">$clientOptions</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">SolrUpdateResponse</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.deletebyid.php" class="methodname">deleteById</a></span>     ( <span class="methodparam"><span class="type">string</span> <code class="parameter">$id</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">SolrUpdateResponse</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.deletebyids.php" class="methodname">deleteByIds</a></span>     ( <span class="methodparam"><span class="type">array</span> <code class="parameter">$ids</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">SolrUpdateResponse</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.deletebyqueries.php" class="methodname">deleteByQueries</a></span>     ( <span class="methodparam"><span class="type">array</span> <code class="parameter">$queries</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">SolrUpdateResponse</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.deletebyquery.php" class="methodname">deleteByQuery</a></span>     ( <span class="methodparam"><span class="type">string</span> <code class="parameter">$query</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">void</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.destruct.php" class="methodname">__destruct</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">SolrQueryResponse</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.getbyid.php" class="methodname">getById</a></span>     ( <span class="methodparam"><span class="type">string</span> <code class="parameter">$id</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">SolrQueryResponse</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.getbyids.php" class="methodname">getByIds</a></span>     ( <span class="methodparam"><span class="type">array</span> <code class="parameter">$ids</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">string</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.getdebug.php" class="methodname">getDebug</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">array</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.getoptions.php" class="methodname">getOptions</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">SolrUpdateResponse</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.optimize.php" class="methodname">optimize</a></span>     ([ <span class="methodparam"><span class="type">int</span> <code class="parameter">$maxSegments</code><span class="initializer"> = 1</span></span>    [, <span class="methodparam"><span class="type">bool</span> <code class="parameter">$softCommit</code><span class="initializer"> = <strong><code>TRUE</code></strong></span></span>    [, <span class="methodparam"><span class="type">bool</span> <code class="parameter">$waitSearcher</code><span class="initializer"> = <strong><code>TRUE</code></strong></span></span>   ]]] )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">SolrPingResponse</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.ping.php" class="methodname">ping</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">SolrQueryResponse</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.query.php" class="methodname">query</a></span>     ( <span class="methodparam"><span class="type"><a href="http://php.net/manual/zh/class.solrparams.php" class="type SolrParams">SolrParams</a></span> <code class="parameter">$query</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">SolrUpdateResponse</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.request.php" class="methodname">request</a></span>     ( <span class="methodparam"><span class="type">string</span> <code class="parameter">$raw_request</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">SolrUpdateResponse</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.rollback.php" class="methodname">rollback</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">void</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.setresponsewriter.php" class="methodname">setResponseWriter</a></span>     ( <span class="methodparam"><span class="type">string</span> <code class="parameter">$responseWriter</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.setservlet.php" class="methodname">setServlet</a></span>     ( <span class="methodparam"><span class="type">int</span> <code class="parameter">$type</code></span>    , <span class="methodparam"><span class="type">string</span> <code class="parameter">$value</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">void</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.system.php" class="methodname">system</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">void</span> <span class="methodname"><a href="http://php.net/manual/zh/solrclient.threads.php" class="methodname">threads</a></span>     ( <span class="methodparam">void</span>    )</div>     }</div>     </div>     <div class="section" id="solrclient.constants">    <h2 class="title">预定义常量</h2>    <dl>             <dt id="solrclient.constants.search-servlet-type"><strong><code>SolrClient::SEARCH_SERVLET_TYPE</code></strong></dt>       <dd>        <p class="para">Used when updating the search servlet.</p>      </dd>                  <dt id="solrclient.constants.update-servlet-type"><strong><code>SolrClient::UPDATE_SERVLET_TYPE</code></strong></dt>       <dd>        <p class="para">Used when updating the update servlet.</p>      </dd>                  <dt id="solrclient.constants.threads-servlet-type"><strong><code>SolrClient::THREADS_SERVLET_TYPE</code></strong></dt>       <dd>        <p class="para">Used when updating the threads servlet.</p>      </dd>                  <dt id="solrclient.constants.ping-servlet-type"><strong><code>SolrClient::PING_SERVLET_TYPE</code></strong></dt>       <dd>        <p class="para">Used when updating the ping servlet.</p>      </dd>                  <dt id="solrclient.constants.terms-servlet-type"><strong><code>SolrClient::TERMS_SERVLET_TYPE</code></strong></dt>       <dd>        <p class="para">Used when updating the terms servlet.</p>      </dd>                      <dt id="solrclient.constants.system-servlet-type"><strong><code>SolrClient::SYSTEM_SERVLET_TYPE</code></strong></dt>       <dd>        <p class="para">Used when retrieving system information from the system servlet.</p>      </dd>                  <dt id="solrclient.constants.default-search-servlet"><strong><code>SolrClient::DEFAULT_SEARCH_SERVLET</code></strong></dt>       <dd>        <p class="para">This is the intial value for the search servlet.</p>      </dd>                  <dt id="solrclient.constants.default-update-servlet"><strong><code>SolrClient::DEFAULT_UPDATE_SERVLET</code></strong></dt>       <dd>        <p class="para">This is the intial value for the update servlet.</p>      </dd>                  <dt id="solrclient.constants.default-threads-servlet"><strong><code>SolrClient::DEFAULT_THREADS_SERVLET</code></strong></dt>       <dd>        <p class="para">This is the intial value for the threads servlet.</p>      </dd>                  <dt id="solrclient.constants.default-ping-servlet"><strong><code>SolrClient::DEFAULT_PING_SERVLET</code></strong></dt>       <dd>        <p class="para">This is the intial value for the ping servlet.</p>      </dd>                  <dt id="solrclient.constants.default-terms-servlet"><strong><code>SolrClient::DEFAULT_TERMS_SERVLET</code></strong></dt>       <dd>        <p class="para">This is the intial value for the terms servlet used for the TermsComponent</p>      </dd>                      <dt id="solrclient.constants.default-system-servlet"><strong><code>SolrClient::DEFAULT_SYSTEM_SERVLET</code></strong></dt>       <dd>        <p class="para">This is the intial value for the system servlet used to obtain Solr Server information</p>      </dd>           </dl>    </div>     </div>                                                                                                                                                               <h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li>{@link SolrClient::addDocument} — Adds a document to the index</li><li>{@link SolrClient::addDocuments} — Adds a collection of SolrInputDocument instances to the index</li><li>{@link SolrClient::commit} — Finalizes all add/deletes made to the index</li><li>{@link SolrClient::__construct} — Constructor for the SolrClient object</li><li>{@link SolrClient::deleteById} — Delete by Id</li><li>{@link SolrClient::deleteByIds} — Deletes by Ids</li><li>{@link SolrClient::deleteByQueries} — Removes all documents matching any of the queries</li><li>{@link SolrClient::deleteByQuery} — Deletes all documents matching the given query</li><li>{@link SolrClient::__destruct} — Destructor for SolrClient</li><li>{@link SolrClient::getById} — Get Document By Id. Utilizes Solr Realtime Get (RTG)</li><li>{@link SolrClient::getByIds} — Get Documents by their Ids. Utilizes Solr Realtime Get (RTG)</li><li>{@link SolrClient::getDebug} — Returns the debug data for the last connection attempt</li><li>{@link SolrClient::getOptions} — Returns the client options set internally</li><li>{@link SolrClient::optimize} — Defragments the index</li><li>{@link SolrClient::ping} — Checks if Solr server is still up</li><li>{@link SolrClient::query} — Sends a query to the server</li><li>{@link SolrClient::request} — Sends a raw update request</li><li>{@link SolrClient::rollback} — Rollbacks all add/deletes made to the index since the last commit</li><li>{@link SolrClient::setResponseWriter} — Sets the response writer used to prepare the response from Solr</li><li>{@link SolrClient::setServlet} — Changes the specified servlet type to a new value</li><li>{@link SolrClient::system} — Retrieve Solr Server information</li><li>{@link SolrClient::threads} — Checks the threads status</li></ul> <div class="up"><a href="http://php.net/manual/zh/book.solr.php">Solr</a></div></div>
*/
