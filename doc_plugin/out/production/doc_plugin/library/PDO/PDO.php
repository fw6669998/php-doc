...
/**
*<div id="class.pdo" class="reference">  <h1 class="title"> PDO 类</h1>      <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PECL pdo &gt;= 0.1.0)</p>      <div class="section" id="pdo.intro">    <h2 class="title">简介</h2>    <p class="para">    代表 PHP 和数据库服务之间的一个连接    </p>   </div>      <div class="section" id="pdo.synopsis">    <h2 class="title">类摘要</h2>       <div class="classsynopsis">     <div class="ooclass"></div>        <div class="classsynopsisinfo">      <span class="ooclass">       <strong class="classname">PDO</strong>      </span>      {</div>        <div class="constructorsynopsis dc-description">    <span class="methodname"><a href="http://php.net/manual/zh/pdo.construct.php" class="methodname">__construct</a></span>     ( <span class="methodparam"><span class="type">string</span> <code class="parameter">$dsn</code></span>    [, <span class="methodparam"><span class="type">string</span> <code class="parameter">$username</code></span>    [, <span class="methodparam"><span class="type">string</span> <code class="parameter">$password</code></span>    [, <span class="methodparam"><span class="type">array</span> <code class="parameter">$driver_options</code></span>   ]]] )</div>      <div class="methodsynopsis dc-description">    <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/pdo.begintransaction.php" class="methodname">beginTransaction</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/pdo.commit.php" class="methodname">commit</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">mixed</span> <span class="methodname"><a href="http://php.net/manual/zh/pdo.errorcode.php" class="methodname">errorCode</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">array</span> <span class="methodname"><a href="http://php.net/manual/zh/pdo.errorinfo.php" class="methodname">errorInfo</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">int</span> <span class="methodname"><a href="http://php.net/manual/zh/pdo.exec.php" class="methodname">exec</a></span>     ( <span class="methodparam"><span class="type">string</span> <code class="parameter">$statement</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">mixed</span> <span class="methodname"><a href="http://php.net/manual/zh/pdo.getattribute.php" class="methodname">getAttribute</a></span>     ( <span class="methodparam"><span class="type">int</span> <code class="parameter">$attribute</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">static</span> <span class="type">array</span>  <span class="methodname"><a href="http://php.net/manual/zh/pdo.getavailabledrivers.php" class="methodname">getAvailableDrivers</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/pdo.intransaction.php" class="methodname">inTransaction</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">string</span> <span class="methodname"><a href="http://php.net/manual/zh/pdo.lastinsertid.php" class="methodname">lastInsertId</a></span>     ([ <span class="methodparam"><span class="type">string</span> <code class="parameter">$name</code><span class="initializer"> = <strong><code>NULL</code></strong></span></span>   ] )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">PDOStatement</span> <span class="methodname"><a href="http://php.net/manual/zh/pdo.prepare.php" class="methodname">prepare</a></span>     ( <span class="methodparam"><span class="type">string</span> <code class="parameter">$statement</code></span>    [, <span class="methodparam"><span class="type">array</span> <code class="parameter">$driver_options</code><span class="initializer"> = array()</span></span>   ] )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">PDOStatement</span> <span class="methodname"><a href="http://php.net/manual/zh/pdo.query.php" class="methodname">query</a></span>     ( <span class="methodparam"><span class="type">string</span> <code class="parameter">$statement</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="modifier">public</span> <span class="type">string</span> <span class="methodname"><a href="http://php.net/manual/zh/pdo.quote.php" class="methodname">quote</a></span>     ( <span class="methodparam"><span class="type">string</span> <code class="parameter">$string</code></span>    [, <span class="methodparam"><span class="type">int</span> <code class="parameter">$parameter_type</code><span class="initializer"> = PDO::PARAM_STR</span></span>   ] )</div> <div class="methodsynopsis dc-description">    <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/pdo.rollback.php" class="methodname">rollBack</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/pdo.setattribute.php" class="methodname">setAttribute</a></span>     ( <span class="methodparam"><span class="type">int</span> <code class="parameter">$attribute</code></span>    , <span class="methodparam"><span class="type"><a href="http://php.net/manual/zh/language.pseudo-types.php#language.types.mixed" class="type mixed">mixed</a></span> <code class="parameter">$value</code></span>    )</div>        }</div>   </div>    </div>                                                                                                                                      <h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li>{@link PDO::beginTransaction} — 启动一个事务</li><li>{@link PDO::commit} — 提交一个事务</li><li>{@link PDO::__construct} — 创建一个表示数据库连接的 PDO 实例</li><li>{@link PDO::errorCode} — 获取跟数据库句柄上一次操作相关的 SQLSTATE</li><li>{@link PDO::errorInfo} — Fetch extended error information associated with the last operation on the database handle</li><li>{@link PDO::exec} — 执行一条 SQL 语句，并返回受影响的行数</li><li>{@link PDO::getAttribute} — 取回一个数据库连接的属性</li><li>{@link PDO::getAvailableDrivers} — 返回一个可用驱动的数组</li><li>{@link PDO::inTransaction} — 检查是否在一个事务内</li><li>{@link PDO::lastInsertId} — 返回最后插入行的ID或序列值</li><li>{@link PDO::prepare} — 准备要执行的语句，并返回语句对象</li><li>{@link PDO::query} — 执行 SQL 语句，以 PDOStatement 对象形式返回结果集</li><li>{@link PDO::quote} — 为 SQL 查询里的字符串添加引号</li><li>{@link PDO::rollBack} — 回滚一个事务</li><li>{@link PDO::setAttribute} — 设置属性</li></ul> <div class="up"><a href="http://php.net/manual/zh/book.pdo.php">PDO</a></div></div>
*/
class PDO  {
...
/**
*<div id="class.pdostatement" class="reference">  <h1 class="title"> PDOStatement 类</h1>      <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PECL pdo &gt;= 1.0.0)</p>      <div class="section" id="pdostatement.intro">    <h2 class="title">简介</h2>    <p class="para">     代表一条预处理语句，并在该语句被执行后代表一个相关的结果集。    </p>   </div>      <div class="section" id="pdostatement.synopsis">    <h2 class="title">类摘要</h2>       <div class="classsynopsis">     <div class="ooclass"></div>        <div class="classsynopsisinfo">      <span class="ooclass">       <strong class="classname">PDOStatement</strong>      </span>        <span class="oointerface">implements        <span class="interfacename"><strong class="interfacename">Traversable</strong></span>      </span>      {</div>        <div class="classsynopsisinfo classsynopsisinfo_comment">// 属性 </div>     <div class="fieldsynopsis"><span class="modifier">readonly</span> <span class="type">string</span> <var class="varname"><a href="http://php.net/manual/zh/class.pdostatement.php#pdostatement.props.querystring">$<var class="varname">queryString</var></a></var>;</div>           <div class="classsynopsisinfo classsynopsisinfo_comment">// 方法 </div>     <div class="methodsynopsis dc-description">     <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.bindcolumn.php" class="methodname">bindColumn</a></span>      ( <span class="methodparam"><span class="type"><a href="http://php.net/manual/zh/language.pseudo-types.php#language.types.mixed" class="type mixed">mixed</a></span> <code class="parameter">$column</code></span>     , <span class="methodparam"><span class="type"><a href="http://php.net/manual/zh/language.pseudo-types.php#language.types.mixed" class="type mixed">mixed</a></span> <code class="parameter reference">&$param</code></span>     [, <span class="methodparam"><span class="type">int</span> <code class="parameter">$type</code></span>     [, <span class="methodparam"><span class="type">int</span> <code class="parameter">$maxlen</code></span>     [, <span class="methodparam"><span class="type"><a href="http://php.net/manual/zh/language.pseudo-types.php#language.types.mixed" class="type mixed">mixed</a></span> <code class="parameter">$driverdata</code></span>    ]]] )</div> <div class="methodsynopsis dc-description">    <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.bindparam.php" class="methodname">bindParam</a></span>     ( <span class="methodparam"><span class="type"><a href="http://php.net/manual/zh/language.pseudo-types.php#language.types.mixed" class="type mixed">mixed</a></span> <code class="parameter">$parameter</code></span>    , <span class="methodparam"><span class="type"><a href="http://php.net/manual/zh/language.pseudo-types.php#language.types.mixed" class="type mixed">mixed</a></span> <code class="parameter reference">&$variable</code></span>    [, <span class="methodparam"><span class="type">int</span> <code class="parameter">$data_type</code><span class="initializer"> = PDO::PARAM_STR</span></span>    [, <span class="methodparam"><span class="type">int</span> <code class="parameter">$length</code></span>    [, <span class="methodparam"><span class="type"><a href="http://php.net/manual/zh/language.pseudo-types.php#language.types.mixed" class="type mixed">mixed</a></span> <code class="parameter">$driver_options</code></span>   ]]] )</div> <div class="methodsynopsis dc-description">    <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.bindvalue.php" class="methodname">bindValue</a></span>     ( <span class="methodparam"><span class="type"><a href="http://php.net/manual/zh/language.pseudo-types.php#language.types.mixed" class="type mixed">mixed</a></span> <code class="parameter">$parameter</code></span>    , <span class="methodparam"><span class="type"><a href="http://php.net/manual/zh/language.pseudo-types.php#language.types.mixed" class="type mixed">mixed</a></span> <code class="parameter">$value</code></span>    [, <span class="methodparam"><span class="type">int</span> <code class="parameter">$data_type</code><span class="initializer"> = PDO::PARAM_STR</span></span>   ] )</div> <div class="methodsynopsis dc-description">    <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.closecursor.php" class="methodname">closeCursor</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">int</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.columncount.php" class="methodname">columnCount</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.debugdumpparams.php" class="methodname">debugDumpParams</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">string</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.errorcode.php" class="methodname">errorCode</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">array</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.errorinfo.php" class="methodname">errorInfo</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.execute.php" class="methodname">execute</a></span>     ([ <span class="methodparam"><span class="type">array</span> <code class="parameter">$input_parameters</code></span>   ] )</div> <div class="methodsynopsis dc-description">    <span class="type">mixed</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.fetch.php" class="methodname">fetch</a></span>     ([ <span class="methodparam"><span class="type">int</span> <code class="parameter">$fetch_style</code></span>    [, <span class="methodparam"><span class="type">int</span> <code class="parameter">$cursor_orientation</code><span class="initializer"> = PDO::FETCH_ORI_NEXT</span></span>    [, <span class="methodparam"><span class="type">int</span> <code class="parameter">$cursor_offset</code><span class="initializer"> = 0</span></span>   ]]] )</div> <div class="methodsynopsis dc-description">    <span class="type">array</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.fetchall.php" class="methodname">fetchAll</a></span>     ([ <span class="methodparam"><span class="type">int</span> <code class="parameter">$fetch_style</code></span>    [, <span class="methodparam"><span class="type"><a href="http://php.net/manual/zh/language.pseudo-types.php#language.types.mixed" class="type mixed">mixed</a></span> <code class="parameter">$fetch_argument</code></span>    [, <span class="methodparam"><span class="type">array</span> <code class="parameter">$ctor_args</code><span class="initializer"> = array()</span></span>   ]]] )</div> <div class="methodsynopsis dc-description">    <span class="type">string</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.fetchcolumn.php" class="methodname">fetchColumn</a></span>     ([ <span class="methodparam"><span class="type">int</span> <code class="parameter">$column_number</code><span class="initializer"> = 0</span></span>   ] )</div> <div class="methodsynopsis dc-description">    <span class="type">mixed</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.fetchobject.php" class="methodname">fetchObject</a></span>     ([ <span class="methodparam"><span class="type">string</span> <code class="parameter">$class_name</code><span class="initializer"> = &quot;stdClass&quot;</span></span>    [, <span class="methodparam"><span class="type">array</span> <code class="parameter">$ctor_args</code></span>   ]] )</div> <div class="methodsynopsis dc-description">    <span class="type">mixed</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.getattribute.php" class="methodname">getAttribute</a></span>     ( <span class="methodparam"><span class="type">int</span> <code class="parameter">$attribute</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">array</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.getcolumnmeta.php" class="methodname">getColumnMeta</a></span>     ( <span class="methodparam"><span class="type">int</span> <code class="parameter">$column</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.nextrowset.php" class="methodname">nextRowset</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">int</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.rowcount.php" class="methodname">rowCount</a></span>     ( <span class="methodparam">void</span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.setattribute.php" class="methodname">setAttribute</a></span>     ( <span class="methodparam"><span class="type">int</span> <code class="parameter">$attribute</code></span>    , <span class="methodparam"><span class="type"><a href="http://php.net/manual/zh/language.pseudo-types.php#language.types.mixed" class="type mixed">mixed</a></span> <code class="parameter">$value</code></span>    )</div> <div class="methodsynopsis dc-description">    <span class="type">bool</span> <span class="methodname"><a href="http://php.net/manual/zh/pdostatement.setfetchmode.php" class="methodname">setFetchMode</a></span>     ( <span class="methodparam"><span class="type">int</span> <code class="parameter">$mode</code></span>    )</div>       }</div>    </div>     <div class="section" id="pdostatement.props">    <h2 class="title">属性</h2>    <dl>            <dt id="pdostatement.props.querystring"><var class="varname"><var class="varname">queryString</var></var></dt>       <dd>        <p class="para">        所用的查询字符串       </p>      </dd>          </dl>   </div>    </div>                                                                                                                                                                                  <h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li>{@link PDOStatement::bindColumn} — 绑定一列到一个 PHP 变量</li><li>{@link PDOStatement::bindParam} — 绑定一个参数到指定的变量名</li><li>{@link PDOStatement::bindValue} — 把一个值绑定到一个参数</li><li>{@link PDOStatement::closeCursor} — 关闭游标，使语句能再次被执行。</li><li>{@link PDOStatement::columnCount} — 返回结果集中的列数</li><li>{@link PDOStatement::debugDumpParams} — 打印一条 SQL 预处理命令</li><li>{@link PDOStatement::errorCode} — 获取跟上一次语句句柄操作相关的 SQLSTATE</li><li>{@link PDOStatement::errorInfo} — 获取跟上一次语句句柄操作相关的扩展错误信息</li><li>{@link PDOStatement::execute} — 执行一条预处理语句</li><li>{@link PDOStatement::fetch} — 从结果集中获取下一行</li><li>{@link PDOStatement::fetchAll} — 返回一个包含结果集中所有行的数组</li><li>{@link PDOStatement::fetchColumn} — 从结果集中的下一行返回单独的一列。</li><li>{@link PDOStatement::fetchObject} — 获取下一行并作为一个对象返回。</li><li>{@link PDOStatement::getAttribute} — 检索一个语句属性</li><li>{@link PDOStatement::getColumnMeta} — 返回结果集中一列的元数据</li><li>{@link PDOStatement::nextRowset} — 在一个多行集语句句柄中推进到下一个行集</li><li>{@link PDOStatement::rowCount} — 返回受上一个 SQL 语句影响的行数</li><li>{@link PDOStatement::setAttribute} — 设置一个语句属性</li><li>{@link PDOStatement::setFetchMode} — 为语句设置默认的获取模式。</li></ul> <div class="up"><a href="http://php.net/manual/zh/book.pdo.php">PDO</a></div></div>
*/
