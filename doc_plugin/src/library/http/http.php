...
class HttpUtil  {
	 ...
	 */
/**
*<div id="function.date" class="refentry">  <div class="refnamediv">   <h1 class="refname">date</h1>   <p class="verinfo">(PHP 4, PHP 5, PHP 7)</p><p class="refpurpose"><span class="refname">date</span> &mdash; <span class="dc-title">格式化一个本地时间／日期</span></p>   </div>  <br></br><div style="BORDER-TOP: gray 1px dashed; OVERFLOW: hidden; HEIGHT: 1px"></div><div class="refsect1 description" id="refsect1-function.date-description">   <h3 class="title">说明</h3>    <div class="methodsynopsis dc-description" style="border:1px gray;padding-left:5px;background:#232525">     <span class="type" style="color:#EAB766">string</span> <span class="methodname" style="color:#CC7832"><strong>date</strong></span>      ( <span class="methodparam"><span class="type" style="color:#EAB766">string</span> <span class="parameter" style="color:#2EACF9">$format</span></span>     [, <span class="methodparam"><span class="type" style="color:#EAB766">int</span> <span class="parameter" style="color:#2EACF9">$timestamp</span></span>    ] )</div>    <p class="para rdfs-comment">    返回将整数 <span class="parameter" style="color:#2EACF9">timestamp</span>    按照给定的格式字串而产生的字符串。如果没有给出时间戳则使用本地当前时间。换句话说，<span class="parameter" style="color:#2EACF9">timestamp</span>    是可选的，默认值为 <span class="function">{@link time()}</span>。   </p>   <div class="tip"><strong class="tip">Tip</strong>    <p class="para">     自 PHP 5.1.1 起有几个有用的<a href="http://php.net/manual/zh/datetime.constants.php" class="link">常量</a>可用作标准的日期／时间格式来指定     <span class="parameter" style="color:#2EACF9">format</span> 参数。    </p>   </div>   <div class="tip"><strong class="tip">Tip</strong>    <p class="para">     自 PHP 5.1 起在 <var class="varname"><var class="varname"><a href="http://php.net/manual/zh/reserved.variables.server.php" class="classname">$_SERVER['REQUEST_TIME']</a></var></var>     中保存了发起该请求时刻的时间戳。    </p>   </div>   <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">Note</strong>:     <p class="para">     有效的时间戳典型范围是格林威治时间 1901 年 12 月 13 日 20:45:54     到 2038 年 1 月 19 日 03:14:07。（此范围符合 32     位有符号整数的最小值和最大值）。不过在 PHP 5.1 之前此范围在某些系统（如     Windows）中限制为从 1970 年 1 月 1 日到 2038 年 1 月 19 日。    </p>   </p></blockquote>   <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">Note</strong>:     <p class="para">     要将字符串表达的时间转换成时间戳，应该使用     <span class="function">{@link strtotime()}</span>。此外一些数据库有一些函数将其时间格式转换成时间戳（例如     MySQL 的 <a href="http://dev.mysql.com/doc/mysql/en/date-and-time-functions.html" class="link external">&raquo;&nbsp;UNIX_TIMESTAMP</a> 函数）。    </p>   </p></blockquote>   <p class="para">    <table class="doctable table">     <caption><strong>格式字串可以识别以下 <span class="parameter" style="color:#2EACF9">format</span> 参数的字符串</strong></caption>           <thead>       <tr>        <th><span class="parameter" style="color:#2EACF9">format</span> 字符</th>        <th>说明</th>        <th>返回值例子</th>       </tr>       </thead>       <tbody class="tbody">       <tr>        <td style="text-align: center;"><em class="emphasis">日</em></td>        <td>---</td>        <td>---</td>       </tr>        <tr>        <td><em>d</em></td>        <td>月份中的第几天，有前导零的 2 位数字</td>        <td><em>01</em> 到 <em>31</em></td>       </tr>        <tr>        <td><em>D</em></td>        <td>星期中的第几天，文本表示，3 个字母</td>        <td><em>Mon</em> 到 <em>Sun</em></td>       </tr>        <tr>        <td><em>j</em></td>        <td>月份中的第几天，没有前导零</td>        <td><em>1</em> 到 <em>31</em></td>       </tr>        <tr>        <td><em>l</em>（“L”的小写字母）</td>        <td>星期几，完整的文本格式</td>        <td><em>Sunday</em> 到 <em>Saturday</em></td>       </tr>        <tr>        <td><em>N</em></td>        <td>ISO-8601 格式数字表示的星期中的第几天（PHP 5.1.0 新加）</td>        <td><em>1</em>（表示星期一）到 <em>7</em>（表示星期天）</td>       </tr>        <tr>        <td><em>S</em></td>        <td>每月天数后面的英文后缀，2 个字符</td>        <td><em>st</em>，<em>nd</em>，<em>rd</em>         或者 <em>th</em>。可以和 <em>j</em> 一起用</td>       </tr>        <tr>        <td><em>w</em></td>        <td>星期中的第几天，数字表示</td>        <td><em>0</em>（表示星期天）到 <em>6</em>（表示星期六）</td>       </tr>        <tr>        <td><em>z</em></td>        <td>年份中的第几天</td>        <td><em>0</em> 到 <em>365</em></td>       </tr>        <tr>        <td style="text-align: center;"><em class="emphasis">星期</em></td>        <td>---</td>        <td>---</td>       </tr>        <tr>        <td><em>W</em></td>        <td>ISO-8601 格式年份中的第几周，每周从星期一开始（PHP 4.1.0 新加的）</td>        <td>例如：<em>42</em>（当年的第 42 周）</td>       </tr>        <tr>        <td style="text-align: center;"><em class="emphasis">月</em></td>        <td>---</td>        <td>---</td>       </tr>        <tr>        <td><em>F</em></td>        <td>月份，完整的文本格式，例如 January 或者 March</td>        <td><em>January</em> 到 <em>December</em></td>       </tr>        <tr>        <td><em>m</em></td>        <td>数字表示的月份，有前导零</td>        <td><em>01</em> 到 <em>12</em></td>       </tr>        <tr>        <td><em>M</em></td>        <td>三个字母缩写表示的月份</td>        <td><em>Jan</em> 到 <em>Dec</em></td>       </tr>        <tr>        <td><em>n</em></td>        <td>数字表示的月份，没有前导零</td>        <td><em>1</em> 到 <em>12</em></td>       </tr>        <tr>        <td><em>t</em></td>        <td>指定的月份有几天</td>        <td><em>28</em> 到 <em>31</em></td>       </tr>        <tr>        <td style="text-align: center;"><em class="emphasis">年</em></td>        <td>---</td>        <td>---</td>       </tr>        <tr>        <td><em>L</em></td>        <td>是否为闰年</td>        <td>如果是闰年为 <em>1</em>，否则为 <em>0</em></td>       </tr>        <tr>        <td><em>o</em></td>        <td>ISO-8601 格式年份数字。这和         <em>Y</em> 的值相同，只除了如果 ISO         的星期数（<em>W</em>）属于前一年或下一年，则用那一年。（PHP 5.1.0 新加）</td>        <td>Examples: <em>1999</em> or <em>2003</em></td>       </tr>        <tr>        <td><em>Y</em></td>        <td>4 位数字完整表示的年份</td>        <td>例如：<em>1999</em> 或 <em>2003</em></td>       </tr>        <tr>        <td><em>y</em></td>        <td>2 位数字表示的年份</td>        <td>例如：<em>99</em> 或 <em>03</em></td>       </tr>        <tr>        <td style="text-align: center;"><em class="emphasis">时间</em></td>        <td>---</td>        <td>---</td>       </tr>        <tr>        <td><em>a</em></td>        <td>小写的上午和下午值</td>        <td><em>am</em> 或 <em>pm</em></td>       </tr>        <tr>        <td><em>A</em></td>        <td>大写的上午和下午值</td>        <td><em>AM</em> 或 <em>PM</em></td>       </tr>        <tr>        <td><em>B</em></td>        <td>Swatch Internet 标准时</td>        <td><em>000</em> 到 <em>999</em></td>       </tr>        <tr>        <td><em>g</em></td>        <td>小时，12 小时格式，没有前导零</td>        <td><em>1</em> 到 <em>12</em></td>       </tr>        <tr>        <td><em>G</em></td>        <td>小时，24 小时格式，没有前导零</td>        <td><em>0</em> 到 <em>23</em></td>       </tr>        <tr>        <td><em>h</em></td>        <td>小时，12 小时格式，有前导零</td>        <td><em>01</em> 到 <em>12</em></td>       </tr>        <tr>        <td><em>H</em></td>        <td>小时，24 小时格式，有前导零</td>        <td><em>00</em> 到 <em>23</em></td>       </tr>        <tr>        <td><em>i</em></td>        <td>有前导零的分钟数</td>        <td><em>00</em> 到 <em>59</em>&gt;</td>       </tr>        <tr>        <td><em>s</em></td>        <td>秒数，有前导零</td>        <td><em>00</em> 到 <em>59</em>&gt;</td>       </tr>        <tr>            <td><em>u</em></td>            <td>             毫秒 （PHP 5.2.2 新加）。需要注意的是             <span class="function"><strong style="color:#CC7832">date()</strong></span> 函数总是返回             <em>000000</em> 因为它只接受 <span class="type" style="color:#EAB766"><a href="http://php.net/manual/zh/language.types.integer.php" class="type integer" style="color:#EAB766">integer</a></span>             参数， 而 <span class="methodname" style="color:#CC7832">{@link DateTime::format()}</span> 才支持毫秒。            </td>            <td>示例: <em>654321</em></td>           </tr>        <tr>        <td style="text-align: center;"><em class="emphasis">时区</em></td>        <td>---</td>        <td>---</td>       </tr>        <tr>        <td><em>e</em></td>        <td>时区标识（PHP 5.1.0 新加）</td>        <td>例如：<em>UTC</em>，<em>GMT</em>，<em>Atlantic/Azores</em></td>       </tr>        <tr>        <td><em>I</em></td>        <td>是否为夏令时</td>        <td>如果是夏令时为 <em>1</em>，否则为 <em>0</em></td>       </tr>        <tr>        <td><em>O</em></td>        <td>与格林威治时间相差的小时数</td>        <td>例如：<em>+0200</em></td>       </tr>        <tr>        <td><em>P</em></td>        <td>与格林威治时间（GMT）的差别，小时和分钟之间有冒号分隔（PHP 5.1.3 新加）</td>        <td>例如：<em>+02:00</em></td>       </tr>        <tr>        <td><em>T</em></td>        <td>本机所在的时区</td>        <td>例如：<em>EST</em>，<em>MDT</em>（【译者注】在 Windows        下为完整文本格式，例如“Eastern Standard Time”，中文版会显示“中国标准时间”）。</td>       </tr>        <tr>        <td><em>Z</em></td>        <td>时差偏移量的秒数。UTC 西边的时区偏移量总是负的，UTC 东边的时区偏移量总是正的。</td>        <td><em>-43200</em> 到 <em>43200</em></td>       </tr>        <tr>        <td style="text-align: center;"><em class="emphasis">完整的日期／时间</em></td>        <td>---</td>        <td>---</td>       </tr>        <tr>        <td><em>c</em></td>        <td>ISO 8601 格式的日期（PHP 5 新加）</td>        <td>2004-02-12T15:19:21+00:00</td>       </tr>        <tr>        <td><em>r</em></td>        <td>RFC 822 格式的日期</td>        <td>例如：<em>Thu, 21 Dec 2000 16:01:07 +0200</em></td>       </tr>        <tr>        <td><em>U</em></td>        <td>从 Unix 纪元（January 1 1970 00:00:00 GMT）开始至今的秒数</td>        <td>参见 <span class="function">{@link time()}</span></td>       </tr>       </tbody>         </table>    </p>   <p class="para">    格式字串中不能被识别的字符将原样显示。<em>Z</em> 格式在使用    <span class="function">{@link gmdate()}</span> 时总是返回 <em>0</em>。   </p>   <p class="para">    <div class="example" id="example-2708">     <p><strong>Example #1 <span class="function"><strong style="color:#CC7832">date()</strong></span> 例子</strong></p>     <div class="example-contents"> <div class="phpcode" style="border-color:gray;background:#232525"><span><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br /></span><span style="color: #FF8000">//&nbsp;设定要用的默认时区。自&nbsp;PHP&nbsp;5.1&nbsp;可用<br /></span><span style="color: #9876AA">date_default_timezone_set</span><span style="color: #007700">(</span><span style="color: #DD0000">'UTC'</span><span style="color: #007700">);<br /><br /><br /></span><span style="color: #FF8000">//&nbsp;输出类似：Monday<br /></span><span style="color: #007700">echo&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"l"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">//&nbsp;输出类似：Monday&nbsp;15th&nbsp;of&nbsp;August&nbsp;2005&nbsp;03:12:46&nbsp;PM<br /></span><span style="color: #007700">echo&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'l&nbsp;dS&nbsp;\of&nbsp;F&nbsp;Y&nbsp;h:i:s&nbsp;A'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">//&nbsp;输出：July&nbsp;1,&nbsp;2000&nbsp;is&nbsp;on&nbsp;a&nbsp;Saturday<br /></span><span style="color: #007700">echo&nbsp;</span><span style="color: #DD0000">"July&nbsp;1,&nbsp;2000&nbsp;is&nbsp;on&nbsp;a&nbsp;"&nbsp;</span><span style="color: #007700">.&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"l"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mktime</span><span style="color: #007700">(</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">7</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">1</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">2000</span><span style="color: #007700">));<br /><br /></span><span style="color: #FF8000">//&nbsp;在格式参数中使用常量&nbsp;<br />//&nbsp;输出类似：Wed,&nbsp;25&nbsp;Sep&nbsp;2013&nbsp;15:28:57&nbsp;-0700<br /></span><span style="color: #007700">echo&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #9876AA">DATE_RFC2822</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">//&nbsp;输出类似：2000-07-01T00:00:00+00:00<br /></span><span style="color: #007700">echo&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #9876AA">DATE_ATOM</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mktime</span><span style="color: #007700">(</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">7</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">1</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">2000</span><span style="color: #007700">));<br /></span><span style="color: #9876AA">?&gt;</span> </span> </span></div>     </div>     </div>   </p>   <p class="para">    在格式字串中的字符前加上反斜线来转义可以避免它被按照上表解释。如果加上反斜线后的字符本身就是一个特殊序列，那还要转义反斜线。    <div class="example" id="example-2709">     <p><strong>Example #2 在 <span class="function"><strong style="color:#CC7832">date()</strong></span> 中转义字符</strong></p>     <div class="example-contents"> <div class="phpcode" style="border-color:gray;background:#232525"><span><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br /></span><span style="color: #FF8000">//&nbsp;prints&nbsp;something&nbsp;like:&nbsp;Wednesday&nbsp;the&nbsp;15th<br /></span><span style="color: #007700">echo&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"l&nbsp;\\t\h\e&nbsp;jS"</span><span style="color: #007700">);<br /></span><span style="color: #9876AA">?&gt;</span> </span> </span></div>     </div>     </div>   </p>   <p class="para">    可以把 <span class="function"><strong style="color:#CC7832">date()</strong></span> 和    <span class="function">{@link mktime()}</span> 函数结合使用来得到未来或过去的日期。    <div class="example" id="example-2710">     <p><strong>Example #3 <span class="function"><strong style="color:#CC7832">date()</strong></span> 和 <span class="function">{@link mktime()}</span> 例子</strong></p>     <div class="example-contents"> <div class="phpcode" style="border-color:gray;background:#232525"><span><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br />$tomorrow&nbsp;&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">mktime</span><span style="color: #007700">(</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"m"</span><span style="color: #007700">)&nbsp;&nbsp;,&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"d"</span><span style="color: #007700">)+</span><span style="color: #9876AA">1</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"Y"</span><span style="color: #007700">));<br /></span><span style="color: #9876AA">$lastmonth&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">mktime</span><span style="color: #007700">(</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"m"</span><span style="color: #007700">)-</span><span style="color: #9876AA">1</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"d"</span><span style="color: #007700">),&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"Y"</span><span style="color: #007700">));<br /></span><span style="color: #9876AA">$nextyear&nbsp;&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">mktime</span><span style="color: #007700">(</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"m"</span><span style="color: #007700">),&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"d"</span><span style="color: #007700">),&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"Y"</span><span style="color: #007700">)+</span><span style="color: #9876AA">1</span><span style="color: #007700">);<br /></span><span style="color: #9876AA">?&gt;</span> </span> </span></div>     </div>     </div>    <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">Note</strong>:      <p class="para">      由于夏令时的缘故，这种方法比简单地在时间戳上加减一天或者一个月的秒数更可靠。     </p>    </p></blockquote>   </p>   <p class="para">    一些使用 <span class="function"><strong style="color:#CC7832">date()</strong></span>    格式化日期的例子。注意要转义所有其它的字符，因为目前有特殊含义的字符会产生不需要的结果，而其余字符在    PHP 将来的版本中可能会被用上。当转义时，注意用单引号以避免类似 \n 的字符变成了换行符。    <div class="example" id="example-2711">     <p><strong>Example #4 <span class="function"><strong style="color:#CC7832">date()</strong></span> 格式举例</strong></p>     <div class="example-contents"> <div class="phpcode" style="border-color:gray;background:#232525"><span><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br /></span><span style="color: #FF8000">//&nbsp;假定今天是：March&nbsp;10th,&nbsp;2001,&nbsp;5:16:18&nbsp;pm<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"F&nbsp;j,&nbsp;Y,&nbsp;g:i&nbsp;a"</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;March&nbsp;10,&nbsp;2001,&nbsp;5:16&nbsp;pm<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"m.d.y"</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;03.10.01<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"j,&nbsp;n,&nbsp;Y"</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;10,&nbsp;3,&nbsp;2001<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"Ymd"</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;20010310<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'h-i-s,&nbsp;j-m-y,&nbsp;it&nbsp;is&nbsp;w&nbsp;Day&nbsp;z&nbsp;'</span><span style="color: #007700">);&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;05-16-17,&nbsp;10-03-01,&nbsp;1631&nbsp;1618&nbsp;6&nbsp;Fripm01<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'\i\t&nbsp;\i\s&nbsp;\t\h\e&nbsp;jS&nbsp;\d\a\y.'</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;It&nbsp;is&nbsp;the&nbsp;10th&nbsp;day.<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"D&nbsp;M&nbsp;j&nbsp;G:i:s&nbsp;T&nbsp;Y"</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;Sat&nbsp;Mar&nbsp;10&nbsp;15:16:08&nbsp;MST&nbsp;2001<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'H:m:s&nbsp;\m&nbsp;\i\s\&nbsp;\m\o\n\t\h'</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;17:03:17&nbsp;m&nbsp;is&nbsp;month<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"H:i:s"</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;17:16:17<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"Y-m-d&nbsp;H:i:s"</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;2001-03-10&nbsp;17:16:18&nbsp;（MySQL&nbsp;DATETIME&nbsp;格式）<br /></span><span style="color: #9876AA">?&gt;</span> </span> </span></div>     </div>     </div>   </p>   <p class="para">    要格式化其它语种的日期，应该用 <span class="function">{@link setlocale()}</span> 和    <span class="function">{@link strftime()}</span> 函数来代替 <span class="function"><strong style="color:#CC7832">date()</strong></span>。   </p>   <p class="para">    参见 <span class="function">{@link getlastmod()}</span>，<span class="function">{@link gmdate()}</span>，<span class="function">{@link mktime()}</span>，<span class="function">{@link strftime()}</span>    和 <span class="function">{@link time()}</span>。   </p>  </div>    <br></br><div style="BORDER-TOP: gray 1px dashed; OVERFLOW: hidden; HEIGHT: 1px"></div><div class="refsect1 parameters" id="refsect1-function.date-parameters">   <h3 class="title">参数</h3>   <span>    <dl>            <dt> <span class="parameter" style="color:#2EACF9">format</span></dt>       <dd>        <p class="para">        输出的日期 <span class="type" style="color:#EAB766"><a href="http://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> 格式。 参见下文中的        格式化选项。 同时，还可以使用        <a href="http://php.net/manual/zh/class.datetimeinterface.php#datetime.constants.types" class="link">预定义日期常量</a>        ，例如：常量 <strong><span>DATE_RSS</span></strong>        表示格式化字符串 <em>&#039;D, d M Y H:i:s&#039;</em>。       </p>       <p class="para">        <table class="doctable table">         <caption><strong>         <span class="parameter" style="color:#2EACF9">format</span> 参数字符串中可识别下列字符</strong></caption>                   <thead>           <tr>            <th><span class="parameter" style="color:#2EACF9">format</span> 字符</th>            <th>描述</th>            <th>返回值示例</th>           </tr>           </thead>           <tbody class="tbody">           <tr>            <td style="text-align: center;"><em class="emphasis">天</em></td>            <td>---</td>            <td>---</td>           </tr>            <tr>            <td><em>d</em></td>            <td>一个月中的第几天，有前导 0 的 2 位数字</td>            <td>从 <em>01</em> 到 <em>31</em></td>           </tr>            <tr>            <td><em>D</em></td>            <td>3 个字符表示的星期几</td>            <td>从 <em>Mon</em> 到 <em>Sun</em></td>           </tr>            <tr>            <td><em>j</em></td>            <td>一个月中的第几天，无前导 0</td>            <td>从 <em>1</em> 到 <em>31</em></td>           </tr>            <tr>            <td><em>l</em> (lowercase &#039;L&#039;)</td>            <td>星期几，英文全称</td>            <td>从 <em>Sunday</em> 到 <em>Saturday</em></td>           </tr>            <tr>            <td><em>N</em></td>            <td>ISO-8601 规定的数字表示的星期几（PHP 5.1.0              新加             ）</td>            <td>从 <em>1</em> （表示星期一）到 <em>7</em> （表示星期日）</td>           </tr>            <tr>            <td><em>S</em></td>            <td>一个月中的第几天，带有 2 个字符表示的英语序数词。</td>            <td>             <em>st</em>， <em>nd</em>， <em>rd</em> 或者             <em>th</em>。  可以和 <em>j</em> 联合使用。            </td>           </tr>            <tr>            <td><em>w</em></td>            <td>数字表示的星期几</td>            <td>从 <em>0</em> （星期日） 到 <em>6</em> （星期六）</td>           </tr>            <tr>            <td><em>z</em></td>            <td>一年中的第几天，从 0 开始计数</td>            <td>从 <em>0</em> 到 <em>365</em></td>           </tr>            <tr>            <td style="text-align: center;"><em class="emphasis">周</em></td>            <td>---</td>            <td>---</td>           </tr>            <tr>            <td><em>W</em></td>            <td>ISO-8601 规范的一年中的第几周，周一视为一周开始。（PHP 4.1.0 新加）</td>            <td>示例： <em>42</em> （本年第42周）</td>           </tr>            <tr>            <td style="text-align: center;"><em class="emphasis">月</em></td>            <td>---</td>            <td>---</td>           </tr>            <tr>            <td><em>F</em></td>            <td>月份英文全拼，例如：January 或 March</td>            <td>从 <em>January</em> 到 <em>December</em></td>           </tr>            <tr>            <td><em>m</em></td>            <td>带有 0 前导的数字表示的月份</td>            <td>从 <em>01</em> 到 <em>12</em></td>           </tr>            <tr>            <td><em>M</em></td>            <td>3 个字符表示的月份的英文简拼</td>            <td>从 <em>Jan</em> 到 <em>Dec</em></td>           </tr>            <tr>            <td><em>n</em></td>            <td>月份的数字表示，无前导 0 </td>            <td><em>1</em> through <em>12</em></td>           </tr>            <tr>            <td><em>t</em></td>            <td>给定月份中包含多少天</td>            <td>从 <em>28</em> 到 <em>31</em></td>           </tr>            <tr>            <td style="text-align: center;"><em class="emphasis">年</em></td>            <td>---</td>            <td>---</td>           </tr>            <tr>            <td><em>L</em></td>            <td>是否为闰年</td>            <td>如果是闰年，则返回 <em>1</em>，反之返回 <em>0</em>。</td>           </tr>            <tr>            <td><em>o</em></td>            <td>ISO-8601 规范的年份，同             <em>Y</em> 格式。有一种情况除外：当 ISO 的周数（<em>W</em>）属于前一年或者后一年时，会返回前一年或者后一年的年份数字表达。             属于前一年或者后一年时，会返回前一年或者后一年的年份数字表达。             （PHP 5.1.0 新加）</td>            <td>示例：<em>1999</em> 或 <em>2003</em></td>           </tr>            <tr>            <td><em>Y</em></td>            <td>4 位数字的年份</td>            <td>示例：<em>1999</em> 或 <em>2003</em></td>           </tr>            <tr>            <td><em>y</em></td>            <td>2 位数字的年份</td>            <td>示例： <em>99</em> 或 <em>03</em></td>           </tr>            <tr>            <td style="text-align: center;"><em class="emphasis">时间</em></td>            <td>---</td>            <td>---</td>           </tr>            <tr>            <td><em>a</em></td>            <td>上午还是下午，2 位小写字符</td>            <td><em>am</em> 或 <em>pm</em></td>           </tr>            <tr>            <td><em>A</em></td>            <td>上午还是下午，2 位大写字符</td>            <td><em>AM</em> 或 <em>PM</em></td>           </tr>            <tr>            <td><em>B</em></td>            <td>斯沃琪因特网时间</td>            <td>从 <em>000</em> 到 <em>999</em></td>           </tr>            <tr>            <td><em>g</em></td>            <td>小时，12时制，无前导 0 </td>            <td>从 <em>1</em> 到 <em>12</em></td>           </tr>            <tr>            <td><em>G</em></td>            <td>小时，24时制，无前导 0 </td>            <td>从 <em>0</em> 到 <em>23</em></td>           </tr>            <tr>            <td><em>h</em></td>            <td>小时，12时制，有前导 0 的 2 位数字</td>            <td>从 <em>01</em> 到 <em>12</em></td>           </tr>            <tr>            <td><em>H</em></td>            <td>小时，24时制，有前导 0 的 2 位数字</td>            <td><em>00</em> through <em>23</em></td>           </tr>            <tr>            <td><em>i</em></td>            <td>分钟，有前导 0 的 2 位数字</td>            <td>从 <em>00</em> 到 <em>59</em></td>           </tr>            <tr>            <td><em>s</em></td>            <td>秒，有前导 0 的 2 位数字</td>            <td>从 <em>00</em> 到 <em>59</em></td>           </tr>            <tr>            <td><em>u</em></td>            <td>毫秒 （PHP 5.2.2 新加）</td>            <td>示例： <em>654321</em></td>           </tr>            <tr>            <td style="text-align: center;"><em class="emphasis">时区</em></td>            <td>---</td>            <td>---</td>           </tr>            <tr>            <td><em>e</em></td>            <td>时区标识（PHP 5.1.0 新加）</td>            <td>示例: <em>UTC</em>, <em>GMT</em>, <em>Atlantic/Azores</em></td>           </tr>            <tr>            <td><em>I</em> （大写字母 i）</td>            <td>是否夏令时</td>            <td>如果是夏令时则返回 <em>1</em>，反之返回 <em>0</em>。</td>           </tr>            <tr>            <td><em>O</em></td>            <td>和格林威治时间（GMT）的时差，以小时为单位</td>            <td>示例： <em>+0200</em></td>           </tr>            <tr>            <td><em>P</em></td>            <td>和格林威治时间（GMT）的时差，包括小时和分钟，小时和分钟之间使用冒号（:）分隔（PHP 5.1.3 新加）</td>            <td>示例： <em>+02:00</em></td>           </tr>            <tr>            <td><em>T</em></td>            <td>时区缩写</td>            <td>示例：<em>EST</em>, <em>MDT</em> ...</td>           </tr>            <tr>            <td><em>Z</em></td>            <td>以秒为单位的时区偏移量。UTC 以西的时区返回负数，UTC 以东的时区返回正数。</td>            <td>从 <em>-43200</em> 到 <em>50400</em></td>           </tr>            <tr>            <td style="text-align: center;"><em class="emphasis">完整的日期/时间</em></td>            <td>---</td>            <td>---</td>           </tr>            <tr>            <td><em>c</em></td>            <td>ISO 8601 日期及时间（PHP 5 新加）</td>            <td>2004-02-12T15:19:21+00:00</td>           </tr>            <tr>            <td><em>r</em></td>            <td><a href="http://www.faqs.org/rfcs/rfc2822" class="link external">&raquo;&nbsp;RFC 2822</a> 格式的日期和时间</td>            <td>示例：<em>Thu, 21 Dec 2000 16:01:07 +0200</em></td>           </tr>            <tr>            <td><em>U</em></td>            <td>自 1970 年 1 月 1 日 0 时 0 分 0 秒（GMT 时间）以来的时间，以秒为单位</td>            <td>参见<span class="function">{@link time()}</span></td>           </tr>           </tbody>                 </table>        </p>       <p class="para">        格式化字符串中的不可识别字符将原样输出。        当使用 <span class="function">{@link gmdate()}</span> 函数时， <em>Z</em> 格式永远返回 <em>0</em>。       </p>              <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">Note</strong>:         <p class="para">         由于本函数仅接受 <span class="type" style="color:#EAB766"><a href="http://php.net/manual/zh/language.types.integer.php" class="type integer" style="color:#EAB766">integer</a></span> 类型的时间戳参数，所以         <em>u</em> 格式仅在使用 <span class="function">{@link date_format()}</span> 函数并且使用         <span class="function">{@link date_create()}</span> 函数创建时间戳时才是有用的。        </p>       </p></blockquote>      </dd>                <dt> <span class="parameter" style="color:#2EACF9">timestamp</span></dt> <dd> <p class="para"> 可选的 <span class="parameter" style="color:#2EACF9">timestamp</span> 参数是一个 <span class="type" style="color:#EAB766"><a href="http://php.net/manual/zh/language.types.integer.php" class="type integer" style="color:#EAB766">integer</a></span> 的 Unix 时间戳，如未指定，参数值默认为当前本地时间。也就是说，其值默认为 <span class="function">{@link time()}</span> 的返回值。</p></dd>         </dl>    </span>  </div>    <br></br><div style="BORDER-TOP: gray 1px dashed; OVERFLOW: hidden; HEIGHT: 1px"></div><div class="refsect1 returnvalues" id="refsect1-function.date-returnvalues">   <h3 class="title">返回值</h3>   <p class="para">    返回格式化后的日期时间的字符串表达。    如果 <span class="parameter" style="color:#2EACF9">timestamp</span> 参数不是一个有效数值，则返回 <strong><span>FALSE</span></strong>     并引发 <strong><span>E_WARNING</span></strong> 级别的错误。   </p>  </div>    <br></br><div style="BORDER-TOP: gray 1px dashed; OVERFLOW: hidden; HEIGHT: 1px"></div><div class="refsect1 errors" id="refsect1-function.date-errors">   <h3 class="title">错误／异常</h3>        <p class="para"> 在每 次调用日期/时间函数时，如果时区无效则会引发 <strong><span>E_NOTICE</span></strong> 错误，如果使用系统设定值或 <var class="varname"><var class="varname">TZ</var></var> 环境变量，则会引发 <strong><span>E_STRICT</span></strong> 或 <strong><span>E_WARNING</span></strong> 消息。参见 <span class="function">{@link date_default_timezone_set()}</span>。</p>    </div>    <br></br><div style="BORDER-TOP: gray 1px dashed; OVERFLOW: hidden; HEIGHT: 1px"></div><div class="refsect1 changelog" id="refsect1-function.date-changelog">   <h3 class="title">更新日志</h3>   <span>    <table class="doctable informaltable">           <thead>       <tr>        <th>版本</th>        <th>说明</th>       </tr>       </thead>       <tbody class="tbody">       <tr>        <td>5.1.0</td>        <td>         时间戳的有效取值范围为 GMT 时间的 1901 年 12 月 13 日至 GMT 时间的 2038 年 1 月 19 日。         （32 位有符号整数的取值范围）。         但是，在 PHP 5.1.0 之前的版本，在某些系统（例如 Windows）上有效取值范围为 1970 年 1 月 1 日至 2038 年 1 月 19 日。        </td>       </tr>               <tr><td>5.1.0</td><td><p class="para"> 现在发布 <strong><span>E_STRICT</span></strong> 和 <strong><span>E_NOTICE</span></strong> 时区错误。</p></td></tr>         <tr>        <td>5.1.1</td>        <td>         <span class="parameter" style="color:#2EACF9">format</span> 参数标准的可用日期/时间格式常量见： <a href="http://php.net/manual/zh/datetime.constants.php" class="link">常量</a>         </td>       </tr>       </tbody>         </table>    </span>  </div>    <br></br><div style="BORDER-TOP: gray 1px dashed; OVERFLOW: hidden; HEIGHT: 1px"></div><div class="refsect1 examples" id="refsect1-function.date-examples">   <h3 class="title">范例</h3>   <span>    <div class="example" id="example-2712">     <p><strong>Example #5 <span class="function"><strong style="color:#CC7832">date()</strong></span> 函数示例</strong></p>     <div class="example-contents"> <div class="phpcode" style="border-color:gray;background:#232525"><span><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br /></span><span style="color: #FF8000">//&nbsp;设置默认时区。PHP&nbsp;5.1&nbsp;之后版本可用<br /></span><span style="color: #9876AA">date_default_timezone_set</span><span style="color: #007700">(</span><span style="color: #DD0000">'UTC'</span><span style="color: #007700">);<br /><br /><br /></span><span style="color: #FF8000">//&nbsp;输出类似：&nbsp;Monday<br /></span><span style="color: #007700">echo&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"l"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">//&nbsp;输出类似：Monday&nbsp;8th&nbsp;of&nbsp;August&nbsp;2005&nbsp;03:12:46&nbsp;PM<br /></span><span style="color: #007700">echo&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'l&nbsp;jS&nbsp;\of&nbsp;F&nbsp;Y&nbsp;h:i:s&nbsp;A'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">//&nbsp;输出：July&nbsp;1,&nbsp;2000&nbsp;is&nbsp;on&nbsp;a&nbsp;Saturday<br /></span><span style="color: #007700">echo&nbsp;</span><span style="color: #DD0000">"July&nbsp;1,&nbsp;2000&nbsp;is&nbsp;on&nbsp;a&nbsp;"&nbsp;</span><span style="color: #007700">.&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"l"</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mktime</span><span style="color: #007700">(</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">7</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">1</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">2000</span><span style="color: #007700">));<br /><br /></span><span style="color: #FF8000">//&nbsp;使用格式常量&nbsp;<br />//&nbsp;输出类似：&nbsp;Mon,&nbsp;15&nbsp;Aug&nbsp;2005&nbsp;15:12:46&nbsp;UTC<br /></span><span style="color: #007700">echo&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #9876AA">DATE_RFC822</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">//&nbsp;输出类似：2000-07-01T00:00:00+00:00<br /></span><span style="color: #007700">echo&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #9876AA">DATE_ATOM</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">mktime</span><span style="color: #007700">(</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">7</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">1</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">2000</span><span style="color: #007700">));<br /></span><span style="color: #9876AA">?&gt;</span> </span> </span></div>     </div>     </div>   </span>   <p class="para">    可以使用反斜线进行转义来阻止函数解析格式字符串中的可识别字符。    如果反斜线和要转义的字符连在一起依然是一个有效的字符序列，那么需要对    反斜线再次进行转义。    <div class="example" id="example-2713">     <p><strong>Example #6 对 <span class="function"><strong style="color:#CC7832">date()</strong></span> 函数中的格式字符串进行转义</strong></p>     <div class="example-contents"> <div class="phpcode" style="border-color:gray;background:#232525"><span><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br /></span><span style="color: #FF8000">//&nbsp;输出类似：&nbsp;Wednesday&nbsp;the&nbsp;15th<br /></span><span style="color: #007700">echo&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'l&nbsp;\t\h\e&nbsp;jS'</span><span style="color: #007700">);<br /></span><span style="color: #9876AA">?&gt;</span> </span> </span></div>     </div>     </div>   </p>   <p class="para">    可以联合使用 <span class="function"><strong style="color:#CC7832">date()</strong></span>     和 <span class="function">{@link mktime()}</span> 函数    来构造之前或者之后的日期时间。    <div class="example" id="example-2714">     <p><strong>Example #7 <span class="function"><strong style="color:#CC7832">date()</strong></span> 和 <span class="function">{@link mktime()}</span> 联合使用示例</strong></p>     <div class="example-contents"> <div class="phpcode" style="border-color:gray;background:#232525"><span><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br />$tomorrow&nbsp;&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">mktime</span><span style="color: #007700">(</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"m"</span><span style="color: #007700">)&nbsp;&nbsp;,&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"d"</span><span style="color: #007700">)+</span><span style="color: #9876AA">1</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"Y"</span><span style="color: #007700">));<br /></span><span style="color: #9876AA">$lastmonth&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">mktime</span><span style="color: #007700">(</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"m"</span><span style="color: #007700">)-</span><span style="color: #9876AA">1</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"d"</span><span style="color: #007700">),&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"Y"</span><span style="color: #007700">));<br /></span><span style="color: #9876AA">$nextyear&nbsp;&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">mktime</span><span style="color: #007700">(</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">0</span><span style="color: #007700">,&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"m"</span><span style="color: #007700">),&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"d"</span><span style="color: #007700">),&nbsp;&nbsp;&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"Y"</span><span style="color: #007700">)+</span><span style="color: #9876AA">1</span><span style="color: #007700">);<br /></span><span style="color: #9876AA">?&gt;</span> </span> </span></div>     </div>     </div>    <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">Note</strong>:      <p class="para">      由于存在夏令时时间，      所以此方案相对于直接在时间戳上加/减秒数      要更加可靠。     </p>    </p></blockquote>   </p>   <p class="para">    <span class="function"><strong style="color:#CC7832">date()</strong></span> 函数格式化的一些示例。    需要注意的是，即使是对于当前来说并不具有特殊含义的字符，    也要像对待具有特殊含义的字符那样进行转义，以避免函数返回非预期的值。    因为可能在将来的 PHP 版本中，这些字符会被赋予特殊的含义。    进行转义的时候，请确保使用单引号，以避免 \n 被解释为换行符号。    <div class="example" id="example-2715">     <p><strong>Example #8 <span class="function"><strong style="color:#CC7832">date()</strong></span> 函数格式化</strong></p>     <div class="example-contents"> <div class="phpcode" style="border-color:gray;background:#232525"><span><span style="color: #000000"> <span style="color: #9876AA">&lt;?php<br /></span><span style="color: #FF8000">//&nbsp;假设今天是&nbsp;2001&nbsp;年&nbsp;3&nbsp;月&nbsp;10&nbsp;日下午&nbsp;5&nbsp;点&nbsp;16&nbsp;分&nbsp;18&nbsp;秒，<br />//&nbsp;并且位于山区标准时间（MST）时区<br /><br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"F&nbsp;j,&nbsp;Y,&nbsp;g:i&nbsp;a"</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;March&nbsp;10,&nbsp;2001,&nbsp;5:16&nbsp;pm<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"m.d.y"</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;03.10.01<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"j,&nbsp;n,&nbsp;Y"</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;10,&nbsp;3,&nbsp;2001<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"Ymd"</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;20010310<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'h-i-s,&nbsp;j-m-y,&nbsp;it&nbsp;is&nbsp;w&nbsp;Day'</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;05-16-18,&nbsp;10-03-01,&nbsp;1631&nbsp;1618&nbsp;6&nbsp;Satpm01<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'\i\t&nbsp;\i\s&nbsp;\t\h\e&nbsp;jS&nbsp;\d\a\y.'</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;it&nbsp;is&nbsp;the&nbsp;10th&nbsp;day.<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"D&nbsp;M&nbsp;j&nbsp;G:i:s&nbsp;T&nbsp;Y"</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;Sat&nbsp;Mar&nbsp;10&nbsp;17:16:18&nbsp;MST&nbsp;2001<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'H:m:s&nbsp;\m&nbsp;\i\s\&nbsp;\m\o\n\t\h'</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;17:03:18&nbsp;m&nbsp;is&nbsp;month<br /></span><span style="color: #9876AA">$today&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #9876AA">date</span><span style="color: #007700">(</span><span style="color: #DD0000">"H:i:s"</span><span style="color: #007700">);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;17:16:18<br /></span><span style="color: #9876AA">?&gt;</span> </span> </span></div>     </div>     </div>   </p>   <p class="para">    如果需要将日期时间格式化为其他语言，你应该使用    <span class="function">{@link setlocale()}</span> 和 <span class="function">{@link strftime()}</span> 函数    来替代 <span class="function"><strong style="color:#CC7832">date()</strong></span> 函数。   </p>  </div>    <br></br><div style="BORDER-TOP: gray 1px dashed; OVERFLOW: hidden; HEIGHT: 1px"></div><div class="refsect1 notes" id="refsect1-function.date-notes">   <h3 class="title">注释</h3>   <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">Note</strong>:     <p class="para">     使用 <span class="function">{@link strtotime()}</span> 函数将一个字符串表达的日期时间转换为时间戳。     另外，一些数据库产品也提供了将日期时间格式转换为时间戳的函数。     （例如 MySQL 中的     <a href="http://dev.mysql.com/doc/mysql/en/date-and-time-functions.html" class="link external">&raquo;&nbsp;UNIX_TIMESTAMP</a> 函数）。    </p>   </p></blockquote>   <div class="tip"><strong class="tip">Tip</strong>    <p class="para">     从 PHP 5.1 版本开始，请求的开始时间可以从变量     <var class="varname"><var class="varname"><a href="http://php.net/manual/zh/reserved.variables.server.php" class="classname">$_SERVER['REQUEST_TIME']</a></var></var> 中获取。    </p>   </div>  </div>    <br></br><div style="BORDER-TOP: gray 1px dashed; OVERFLOW: hidden; HEIGHT: 1px"></div><div class="refsect1 seealso" id="refsect1-function.date-seealso">   <h3 class="title">参见</h3>   <span>    <ul class="simplelist">     <li class="member"><span class="function">{@link gmdate()} - 格式化一个 GMT/UTC 日期／时间</span></li>     <li class="member"><span class="function">{@link idate()} - 将本地时间日期格式化为整数</span></li>     <li class="member"><span class="function">{@link getdate()} - 取得日期／时间信息</span></li>     <li class="member"><span class="function">{@link getlastmod()} - 获取页面最后修改的时间</span></li>     <li class="member"><span class="function">{@link mktime()} - 取得一个日期的 Unix 时间戳</span></li>     <li class="member"><span class="function">{@link strftime()} - 根据区域设置格式化本地时间／日期</span></li>     <li class="member"><span class="function">{@link time()} - 返回当前的 Unix 时间戳</span></li>     <li class="member"><span class="function">{@link strtotime()} - 将任何字符串的日期时间描述解析为 Unix 时间戳</span></li>     <li class="member"><a href="http://php.net/manual/zh/class.datetimeinterface.php#datetime.constants.types" class="link">预定义的日期时间常量</a></li>    </ul>   </span>  </div>  <div class="up"><a href="http://php.net/manual/zh/ref.datetime.php">Date/Time 函数</a></div></div>
*/
